                        ...
                        <CardContent className="space-y-4 text-zinc-200">
                            ...
                            {language === "de" ? (
                                <>
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-zinc-300">Haftung für Inhalte</h3>
                                    <p>
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-zinc-300">Haftung für Links</h3>
                                    <p>
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-zinc-300">Urheberrecht</h3>
                                    <p>
                                ...
                                <>
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-zinc-300">Liability for Content</h3>
                                    <p>
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-zinc-300">Liability for Links</h3>
                                    <p>
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-zinc-300">Copyright</h3>
                                    <p>
