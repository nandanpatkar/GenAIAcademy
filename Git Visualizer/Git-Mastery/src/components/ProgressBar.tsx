            ...
            <div className={className}>
                <div className="mb-1 flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center text-base font-medium">
                        <span>Progress</span>
                        {currentMilestone && (
                            <div className="ml-2 flex items-center rounded-full border border-emerald-700/50 bg-zinc-900/30 px-2 py-0.5 text-xs text-zinc-300">
                    ...
                    <div
                        className={`h-2.5 rounded-full transition-all duration-300 ease-in-out ${
                            isDoubleXpActive
                                ...
                                : "bg-gradient-to-r from-[#00ff88] to-emerald-700"
                        }`}
                ...
                <div className="relative mt-1 h-4 w-full text-xs">
                    {milestones.map((milestone, index) => (
                        <div
                            key={index}
                            className={`absolute ${percentage >= milestone.at ? "text-[#00ff88]" : "text-gray-500"}`}
                            style={{
