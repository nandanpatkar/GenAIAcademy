        ...
        return (
            <Card className="mx-auto max-w-md border-green-600 bg-green-900/20">
                ...
                <CardContent className="space-y-4 text-center">
                    <p className="text-zinc-200">Answer Git branching questions as fast as possible!</p>
                    <p className="text-sm text-zinc-300">
                        • Difficulty: {difficulty.charAt(0).toUpperCase() + difficulty.slice(1)}
                    </p>
                    <p className="text-sm text-zinc-300">• 8 questions • 60 seconds • Bonus points for speed</p>
                        ...
                        <Button
                            ...
                            className={`p-4 text-left transition-all duration-200 ${
                                showResult
                                    ...
                                    : "border-emerald-700 bg-zinc-900/30 text-zinc-100 hover:border-emerald-600 hover:bg-zinc-900/50"
                            }`}
                            variant="outline">
                    ...
                    <div className="text-center">
                        ...
                        {selectedAnswer !== challenge?.correctAnswer && (
                            <p className="mt-1 text-sm text-zinc-300">
                                Correct answer:{" "}
                                <code className="rounded bg-zinc-900/50 px-2 py-1 font-mono">
