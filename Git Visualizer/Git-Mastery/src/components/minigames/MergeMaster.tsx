        ...
        return (
            <Card className="mx-auto max-w-md border-red-600 bg-red-900/20">
                ...
                <CardContent className="space-y-4 text-center">
                    <p className="text-zinc-200">Resolve merge conflicts like a pro developer!</p>
            ...
            <Card className="mx-auto max-w-md border-red-600 bg-red-900/20">
                ...
                <CardContent className="space-y-4 text-center">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-zinc-200">Resolution Points: {score}</p>
                        <p className="text-sm text-zinc-200">Time Bonus: {Math.floor(timeLeft / 2)} points</p>
                    </div>
            ...
            <CardContent className="space-y-6">
                <div>
                    ...
                    <p className="mb-4 text-sm text-zinc-300">
                        File:{" "}
                        <code className="rounded bg-zinc-900/50 px-2 py-1 font-mono">{scenario?.conflictedFile}</code>
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <div className="flex flex-col">
                        <div className="mb-2 flex h-8 items-center">
                            <h4 className="text-md text-zinc-300">Conflicted Code:</h4>
                        </div>
                    ...
                    <div className="flex flex-col">
                        <div className="mb-2 flex h-8 items-center justify-between">
                            <h4 className="text-md text-zinc-300">Your Resolution:</h4>
                            <Button
                                onClick={handleCopyConflictedCode}
                                variant="outline"
                                size="sm"
                                className="border-emerald-600 text-zinc-300 hover:bg-zinc-900/50"
