        ...
        return (
            <Card className="mx-auto max-w-md border-yellow-600 bg-yellow-900/20">
                ...
                <CardContent className="space-y-4 text-center">
                    <p className="text-zinc-200">Write meaningful commit messages for different scenarios!</p>
                    <p className="text-sm text-zinc-300">
                        • Difficulty: {difficulty.charAt(0).toUpperCase() + difficulty.slice(1)}
                    </p>
                    <p className="text-sm text-zinc-300">• 5 scenarios • 90 seconds • Quality over speed!</p>
            ...
            <Card className="mx-auto max-w-md border-yellow-600 bg-yellow-900/20">
                ...
                <CardContent className="space-y-4 text-center">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-zinc-200">Quality Points: {score}</p>
                        <p className="text-sm text-zinc-200">Time Bonus: {timeLeft} points</p>
                    </div>
                    <div className="flex gap-2">
                        ...
                        <Button onClick={onClose} className="flex-1 bg-[#00cc66] text-white hover:bg-emerald-700">
                            Close
                        </Button>
                    </div>
                </CardContent>
        ...
        <Card className="mx-auto max-w-2xl border-yellow-600 bg-yellow-900/20">
            <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-zinc-300">Score: {score}</div>
                        <Button variant="ghost" size="sm" onClick={onClose} className="text-gray-400 hover:text-white">
                            <X className="h-4 w-4" />
                        </Button>
                    </div>
                ...
                <div className="mt-2">
                    <div className="flex text-sm text-[#00ff88]">
                        Scenario {currentChallenge + 1} of {selectedChallenges.length}
                    </div>
                    <div className="mt-1 h-2 w-full rounded-full bg-zinc-900/30">
                        <div
            ...
            <CardContent className="space-y-6">
                <div className="text-center">
                    ...
                    <div className="mb-4">
                        <p className="mb-2 text-sm text-zinc-300">Files changed:</p>
                        <div className="flex flex-wrap justify-center gap-1">
                            {challenge?.changedFiles.map((file, index) => (
                                <span
                                    key={index}
                                    className="rounded bg-zinc-900/50 px-2 py-1 font-mono text-xs text-zinc-200">
                                    {file}
                                </span>
                            ))}
                        </div>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            className="border-emerald-700 bg-white/10 text-white placeholder-emerald-400"
                            maxLength={72}
                            onKeyPress={e => {
