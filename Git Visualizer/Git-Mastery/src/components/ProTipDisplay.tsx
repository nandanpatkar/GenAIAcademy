...
export function ProTipDisplay() {
    ...
    return (
        <div className="border-t border-blue-500/30 bg-gradient-to-r from-blue-950/95 via-emerald-950/95 to-blue-950/95 px-4 py-2">
            <div className="container mx-auto flex items-center justify-between space-x-3">
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex items-baseline space-x-2">
                        ...
                        <p className="text-xs text-zinc-100">{currentTip}</p>
                    </div>
                </div>
                <Button
                    variant="ghost"
