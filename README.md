...
| `public/labs/` | Standalone interactive HTML labs: 6 top-level (`agent-anatomy-lab.html`, `chunking-bench.html`, `retrieval-lab.html`, `token-cost-lab.html`, `enterprise-ai-agent-problems.html`, `machine-reads-a-sentence.html`) + `data-science/` (30 stats/ML labs) + `python/artifacts/` (50 numbered Python-concept labs) | catalogued directly in `LabsHub.jsx`; data-science set generated from `dataScienceLabCatalog.js`; taxonomy via `labTaxonomy.js` | `LabsHub.jsx` |
