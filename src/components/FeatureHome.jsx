...
// pre-sliced preview of the 12 most recent posts (generated by
// scripts/build_av_archive.py — the same archive avArchiveService.js reads
// full articles from), so the archive never touches the first-paint path.
