...
export const SERVICE_CATALOG = [
  ...
  { id: "customer-entity", label: "Customer", category: "ERD", provider: "Data", iconUrl: null, fallbackIcon: "Users", color: "#0ea5e9", kind: "entity", description: "Customer entity with identity and profile attributes." },
  { id: "order-entity", label: "Order", category: "ERD", provider: "Data", iconUrl: null, fallbackIcon: "Table2", color: "#8b5cf6", kind: "entity", description: "Order entity representing a business transaction." },
  { id: "product-entity", label: "Product", category: "ERD", provider: "Data", iconUrl: null, fallbackIcon: "Archive", color: "#22c55e", kind: "entity", description: "Product catalog entity and inventory reference." },
  { id: "order-item-entity", label: "Order Item", category: "ERD", provider: "Data", iconUrl: null, fallbackIcon: "ListTodo", color: "#f59e0b", kind: "entity", description: "Join entity connecting orders and products." },
  { id: "data-store", label: "Data Store", category: "Data Flow", provider: "Core", iconUrl: null, fallbackIcon: "Database", color: "#06b6d4", kind: "database", description: "Persistent store in a data-flow or information architecture." },
  { id: "terraform", label: "Terraform", category: "Infrastructure", provider: "HashiCorp", iconUrl: null, fallbackIcon: "Code2", color: "#7c3aed", kind: "infrastructure", description: "Infrastructure-as-code module or Terraform workspace." },
  { id: "vpc", label: "VPC", category: "Network", provider: "AWS", iconUrl: null, fallbackIcon: "Globe2", color: "#f59e0b", kind: "network", description: "Private network boundary for cloud resources." },
  { id: "subnet", label: "Subnet", category: "Network", provider: "AWS", iconUrl: null, fallbackIcon: "Network", color: "#38bdf8", kind: "network", description: "Segmented network zone for workloads and data." },
  { id: "k8s-cluster", label: "Kubernetes Cluster", category: "Kubernetes", provider: "CNCF", iconUrl: null, fallbackIcon: "Cloud", color: "#2563eb", kind: "cluster", description: "Kubernetes control plane and worker environment." },
  { id: "k8s-namespace", label: "Namespace", category: "Kubernetes", provider: "CNCF", iconUrl: null, fallbackIcon: "Layers3", color: "#06b6d4", kind: "namespace", description: "Logical Kubernetes namespace boundary." },
  { id: "k8s-ingress", label: "Ingress", category: "Kubernetes", provider: "CNCF", iconUrl: null, fallbackIcon: "Globe2", color: "#22c55e", kind: "ingress", description: "HTTP entry point routing into a Kubernetes service." },
  { id: "k8s-service", label: "Kubernetes Service", category: "Kubernetes", provider: "CNCF", iconUrl: null, fallbackIcon: "GitBranch", color: "#14b8a6", kind: "service", description: "Stable service endpoint for Kubernetes workloads." },
  { id: "k8s-pod", label: "Pod", category: "Kubernetes", provider: "CNCF", iconUrl: null, fallbackIcon: "Layers3", color: "#0ea5e9", kind: "workload", description: "Deployable Kubernetes pod or workload replica." },
  { id: "user-actor", label: "User", category: "People & Flow", provider: "Core", iconUrl: null, fallbackIcon: "Users", color: "#ec4899", kind: "actor", description: "Human actor in a sequence, flow, or journey." },
  { id: "screen-step", label: "Screen", category: "People & Flow", provider: "Product", iconUrl: null, fallbackIcon: "Globe2", color: "#ec4899", kind: "screen", description: "User-facing screen or touchpoint." },
  { id: "bpmn-start", label: "Start Event", category: "BPMN", provider: "Process", iconUrl: null, fallbackIcon: "CircleDot", color: "#22c55e", kind: "event", description: "BPMN process start event." },
  { id: "bpmn-task", label: "Process Task", category: "BPMN", provider: "Process", iconUrl: null, fallbackIcon: "ListTodo", color: "#8b5cf6", kind: "task", description: "BPMN user or service task." },
  { id: "bpmn-gateway", label: "Decision Gateway", category: "BPMN", provider: "Process", iconUrl: null, fallbackIcon: "GitBranch", color: "#f59e0b", kind: "gateway", description: "BPMN branching or decision gateway." },
  { id: "bpmn-end", label: "End Event", category: "BPMN", provider: "Process", iconUrl: null, fallbackIcon: "CircleDot", color: "#ef4444", kind: "event", description: "BPMN process completion event." },
  { id: "state-created", label: "Created", category: "State", provider: "Core", iconUrl: null, fallbackIcon: "CircleDot", color: "#38bdf8", kind: "state", description: "Initial state in a lifecycle." },
  { id: "state-active", label: "Active", category: "State", provider: "Core", iconUrl: null, fallbackIcon: "Activity", color: "#22c55e", kind: "state", description: "Active processing or in-progress state." },
  { id: "state-blocked", label: "Blocked", category: "State", provider: "Core", iconUrl: null, fallbackIcon: "AlertCircle", color: "#f59e0b", kind: "state", description: "Waiting or blocked state requiring attention." },
  { id: "state-complete", label: "Complete", category: "State", provider: "Core", iconUrl: null, fallbackIcon: "CheckCircle2", color: "#10b981", kind: "state", description: "Terminal completed state." },
];
