...
| Parameter | Description | Example | Options |
| --- | --- | --- | --- |
| `audio` | `AudioConfig` instance. | `{"voice": "coral"}` | [reference](lc:api/python/strands.experimental.bidi.types.model#AudioConfig) |
...
-   [Python API Reference](lc:api/python/strands.experimental.bidi.models.openai_realtime#BidiOpenAIRealtimeModel)
