...
See [Model Providers](lc:user-guide/concepts/bidirectional-streaming/models/nova_sonic) for provider-specific options.

`BidiAgent` supports many of the same constructs as `Agent`:

-   **[Tools](lc:user-guide/concepts/tools)**: Function calling works identically
-   **[Hooks](lc:user-guide/concepts/bidirectional-streaming/hooks)**: Lifecycle event handling with bidirectional-specific events
-   **[Session Management](lc:user-guide/concepts/bidirectional-streaming/session-management)**: Conversation persistence across sessions
-   **[Tool Executors](lc:user-guide/concepts/tools/executors)**: Concurrent and custom execution patterns
...
-   [I/O Channels](lc:user-guide/concepts/bidirectional-streaming/io) - Building custom input/output channels
-   [Model Providers](lc:user-guide/concepts/bidirectional-streaming/models/nova_sonic) - Provider-specific configuration
-   [Quickstart](lc:user-guide/concepts/bidirectional-streaming/quickstart) - Getting started guide
...
- [OpenAI Realtime](lc:user-guide/concepts/bidirectional-streaming/models/openai_realtime) (1 shared tag)
...
- [Nova Sonic](lc:user-guide/concepts/bidirectional-streaming/models/nova_sonic) (1 shared tag)
