...
For a comprehensive introduction to the hooks concept and general patterns, see the [Hooks documentation](lc:user-guide/concepts/agents/hooks). This guide focuses on bidirectional streaming-specific events and use cases.
...
For additional best practices on performance considerations, error handling, composability, and advanced patterns, see the [Hooks documentation](lc:user-guide/concepts/agents/hooks).

## Next Steps

-   [Agent](lc:user-guide/concepts/bidirectional-streaming/agent) - Learn about BidiAgent configuration and lifecycle
-   [Session Management](lc:user-guide/concepts/bidirectional-streaming/session-management) - Persist conversations across sessions
