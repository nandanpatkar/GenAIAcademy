...
[
 {
  "label": "Amazon Bedrock Nova Sonic",
...
[
 ...
 {
  "label": "Windows",
  "body": "PyAudio typically installs without additional dependencies.\n\n```bash\npip install \"strands-agents[bidi-all]\"\n```"
 }
]
```
...
[
 {
  "label": "Amazon Bedrock Nova Sonic",
  "body": "Nova Sonic is Amazon\u2019s bidirectional streaming model. Configure AWS credentials:\n\n```bash\nexport AWS_ACCESS_KEY_ID=your_access_key\nexport AWS_SECRET_ACCESS_KEY=your_secret_key\nexport AWS_DEFAULT_REGION=us-east-1\n```\n\nEnable Nova Sonic model access in the [Amazon Bedrock console](https://docs.aws.amazon.com/bedrock/latest/userguide/model-access-modify.html)."
 },
 {
  "label": "OpenAI Realtime API",
  "body": "For OpenAI\u2019s Realtime API, set your API key:\n\n```bash\nexport OPENAI_API_KEY=your_api_key\n```"
 },
 {
  "label": "Google Gemini Live",
  "body": "For Gemini Live API, set your API key:\n\n```bash\nexport GOOGLE_API_KEY=your_api_key\n```"
 }
]
```
...
-   **[Nova Sonic](lc:user-guide/concepts/bidirectional-streaming/models/nova_sonic)** - Amazon’s bidirectional streaming model via AWS Bedrock
-   **[OpenAI Realtime](lc:user-guide/concepts/bidirectional-streaming/models/openai_realtime)** - OpenAI’s Realtime API for voice conversations
-   **[Gemini Live](lc:user-guide/concepts/bidirectional-streaming/models/gemini_live)** - Google’s multimodal streaming API
...
-   [Agent](lc:user-guide/concepts/bidirectional-streaming/agent) - Deep dive into BidiAgent configuration and lifecycle
-   [Events](lc:user-guide/concepts/bidirectional-streaming/events) - Complete guide to bidirectional streaming events
-   [I/O Channels](lc:user-guide/concepts/bidirectional-streaming/io) - Understanding and customizing input/output channels
-   **Model Providers:**
    -   [Nova Sonic](lc:user-guide/concepts/bidirectional-streaming/models/nova_sonic) - Amazon Bedrock’s bidirectional streaming model
    -   [OpenAI Realtime](lc:user-guide/concepts/bidirectional-streaming/models/openai_realtime) - OpenAI’s Realtime API
    -   [Gemini Live](lc:user-guide/concepts/bidirectional-streaming/models/gemini_live) - Google’s Gemini Live API
-   [Python API Reference](lc:api/python/strands.experimental.bidi.agent.agent) - Complete API documentation
...
- [BidiAgent](lc:user-guide/concepts/bidirectional-streaming/agent) (1 shared tag)
- [Events](lc:user-guide/concepts/bidirectional-streaming/events) (1 shared tag)
- [Gemini Live](lc:user-guide/concepts/bidirectional-streaming/models/gemini_live) (1 shared tag)
- [I/O Channels](lc:user-guide/concepts/bidirectional-streaming/io) (1 shared tag)
- [Interruptions](lc:user-guide/concepts/bidirectional-streaming/interruption) (1 shared tag)
