...
For a comprehensive introduction to session management concepts and general patterns, see the [Session Management documentation](lc:user-guide/concepts/agents/session-management). This guide focuses on bidirectional streaming-specific considerations and use cases.
...
> [!WARNING] Conversation History Limits
>
...
For best practices on session ID management, session cleanup, error handling, storage considerations, and troubleshooting, see the [Session Management documentation](lc:user-guide/concepts/agents/session-management).

## Next Steps

-   [Agent](lc:user-guide/concepts/bidirectional-streaming/agent) - Learn about BidiAgent configuration and lifecycle
-   [Hooks](lc:user-guide/concepts/bidirectional-streaming/hooks) - Extend agent functionality with hooks
...
- [Session Management](lc:user-guide/concepts/agents/session-management) (2 shared tags)
- [State Management](lc:user-guide/concepts/agents/state) (2 shared tags)
