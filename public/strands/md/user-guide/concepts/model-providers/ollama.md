...
The [`OllamaModel`](lc:api/python/strands.models.ollama) class in Strands enables seamless integration with Ollama’s API, supporting:
...
The [`OllamaModel`](lc:api/python/strands.models.ollama) supports various [configuration parameters](lc:api/python/strands.models.ollama#OllamaModel.OllamaConfig):
...
Ollama supports structured output for models that have tool calling capabilities. When you pass `structured_output_model` parameter to the [agent invocation](lc:api/python/strands.agent.agent#Agent.__call__), the Strands SDK converts your Pydantic models to tool specifications that compatible Ollama models can understand.
...
- [Llama API](lc:user-guide/concepts/model-providers/llamaapi) (1 shared tag)
- [llama.cpp](lc:user-guide/concepts/model-providers/llamacpp) (1 shared tag)
