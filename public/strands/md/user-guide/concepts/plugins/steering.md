...
> [!NOTE] TypeScript SDK
>
> In TypeScript, steering handlers use the [interventions](lc:user-guide/concepts/agents/interventions/steering) framework rather than plugins. See [Steering (Interventions)](lc:user-guide/concepts/agents/interventions/steering) for the full TypeScript API reference including `SteeringHandler`, `LLMSteeringHandler`, and context providers.
