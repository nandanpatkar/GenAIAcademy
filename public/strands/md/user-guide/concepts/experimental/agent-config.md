...
-   `model`: Model identifier (string) - \[[Only supports AWS Bedrock model provider string](https://strandsagents.com/docs/user-guide/quickstart/#using-a-string-model-id)\]
...
-   `**kwargs`: Additional [Agent constructor parameters](lc:api/python/strands.agent.agent#Agent.__init__) that override config values
