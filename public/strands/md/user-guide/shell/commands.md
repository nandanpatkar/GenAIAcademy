...
The SSRF guard and credential injection on `curl` are security features, covered in the [security model](lc:user-guide/shell/security). They are not optional and cannot be disabled per command.
