...
For the TypeScript equivalent and the full configuration reference, see [Bedrock guardrails](lc:user-guide/concepts/model-providers/amazon-bedrock#guardrails).
...
-   System prompt engineering with safety instructions (see the [Prompt Engineering](lc:user-guide/safety-security/prompt-engineering) section of our documentation)
...
- [Amazon Bedrock](lc:user-guide/concepts/model-providers/amazon-bedrock) (3 shared tags)
