...
-   [Introducing Strands Agent SOPs – Natural Language Workflows for AI Agents](https://strandsagents.com/docs/blog/introducing-strands-agent-sops/)
...
- [Prompts](lc:user-guide/concepts/agents/prompts) (3 shared tags)
