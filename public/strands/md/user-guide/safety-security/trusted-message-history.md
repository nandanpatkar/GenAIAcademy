...
-   [Prompts](lc:user-guide/concepts/agents/prompts) for the input shapes an agent accepts.
-   [Snapshots](lc:user-guide/concepts/agents/snapshots) for capturing and loading agent state.
