...
-   [Simulators Overview](lc:user-guide/evals-sdk/simulators): Learn about the ActorSimulator and simulator framework
-   [Quickstart Guide](lc:user-guide/evals-sdk/quickstart): Get started with Strands Evals
-   [Helpfulness Evaluator](lc:user-guide/evals-sdk/evaluators/helpfulness_evaluator): Evaluate conversation helpfulness
