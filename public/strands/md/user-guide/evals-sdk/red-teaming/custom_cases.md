...
-   **`risk_category`** — Type: `str`. The threat type this case probes. Use one of the built-in [risk categories](lc:user-guide/evals-sdk/red-teaming#risk-categories) (`guideline_bypass`, `system_prompt_leak`, `harmful_content`, `data_exfiltration`, `excessive_agency`) so the judge applies the right success definition.
...
-   [Attack Strategies](lc:user-guide/evals-sdk/red-teaming/strategies): Pick the strategies to attack your cases
-   [Scoring Attacks](lc:user-guide/evals-sdk/red-teaming/evaluators): How `success_criteria` becomes a breach verdict
-   [Quickstart](lc:user-guide/evals-sdk/red-teaming/quickstart): The end-to-end run
