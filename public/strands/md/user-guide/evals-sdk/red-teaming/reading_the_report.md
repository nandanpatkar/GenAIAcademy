...
>
> `RedTeamReport` lives under `strands_evals.experimental.redteam`. The API is still evolving and may change in a minor release.
...
-   [Scoring Attacks](lc:user-guide/evals-sdk/red-teaming/evaluators): How the judge assigns the 0.0–1.0 score behind every cell
-   [Attack Strategies](lc:user-guide/evals-sdk/red-teaming/strategies): The strategies whose results you’re reading
