...
[Complete User Simulation Guide →](lc:user-guide/evals-sdk/simulators/user_simulation)
...
[Complete Tool Simulation Guide →](lc:user-guide/evals-sdk/simulators/tool_simulation)
...
-   [User Simulation Guide](lc:user-guide/evals-sdk/simulators/user_simulation): Simulate multi-turn user conversations
-   [Tool Simulation Guide](lc:user-guide/evals-sdk/simulators/tool_simulation): Simulate tool behavior with LLM-powered responses
-   [Evaluators](lc:user-guide/evals-sdk/evaluators/output_evaluator): Combine with evaluators

## Related Documentation

-   [Quickstart Guide](lc:user-guide/evals-sdk/quickstart): Get started with Strands Evals
-   [Evaluators Overview](lc:user-guide/evals-sdk/evaluators/output_evaluator): Learn about evaluators
