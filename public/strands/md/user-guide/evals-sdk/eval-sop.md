...
-   **Strands Eval SDK**: [Eval SDK Documentation](lc:user-guide/evals-sdk/quickstart)

## Related Tools

-   [**Strands Evaluation SDK**](lc:user-guide/evals-sdk/quickstart): Core evaluation framework and evaluators
-   [**Experiment Generator**](lc:user-guide/evals-sdk/experiment_generator): Automated test case generation
-   [**Output Evaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Custom rubric-based evaluation
-   [**Trajectory Evaluator**](lc:user-guide/evals-sdk/evaluators/trajectory_evaluator): Tool usage and sequence analysis
