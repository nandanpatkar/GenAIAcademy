...
**[`detect_failures`](lc:user-guide/evals-sdk/detectors/failure_detection)**
...
**[`analyze_root_cause`](lc:user-guide/evals-sdk/detectors/root_cause_analysis)**
...
**[`diagnose_session`](lc:user-guide/evals-sdk/detectors/diagnosis)**
...
See the [Session Diagnosis guide](lc:user-guide/evals-sdk/detectors/diagnosis) for the full integration walkthrough.
...
-   [Failure Detection](lc:user-guide/evals-sdk/detectors/failure_detection): Identify what went wrong in agent traces
-   [Root Cause Analysis](lc:user-guide/evals-sdk/detectors/root_cause_analysis): Understand why failures happened
-   [Session Diagnosis](lc:user-guide/evals-sdk/detectors/diagnosis): Run the full pipeline and integrate with experiments

## Related Documentation

-   [Getting Started](lc:user-guide/evals-sdk/quickstart): Set up your first evaluation experiment
-   [Evaluators Overview](lc:user-guide/evals-sdk/evaluators): Score agent performance
-   [Remote Trace Providers](lc:user-guide/evals-sdk/how-to/trace_providers): Fetch traces from production backends

## Related pages

- [Failure Detection](lc:user-guide/evals-sdk/detectors/failure_detection) (2 shared tags)
...
- [Failure Communication Evaluator](lc:user-guide/evals-sdk/evaluators/failure_communication_evaluator) (1 shared tag)
- [Partial Completion Evaluator](lc:user-guide/evals-sdk/evaluators/partial_completion_evaluator) (1 shared tag)
- [Recovery Strategy Evaluator](lc:user-guide/evals-sdk/evaluators/recovery_strategy_evaluator) (1 shared tag)
- [Interrupts](lc:user-guide/concepts/interrupts) (1 shared tag)
