...
-   [Output Evaluator](lc:user-guide/evals-sdk/evaluators/output_evaluator): Evaluate agent response quality
-   [Trajectory Evaluator](lc:user-guide/evals-sdk/evaluators/trajectory_evaluator): Evaluate tool usage and execution paths
-   [Helpfulness Evaluator](lc:user-guide/evals-sdk/evaluators/helpfulness_evaluator): Assess agent helpfulness
