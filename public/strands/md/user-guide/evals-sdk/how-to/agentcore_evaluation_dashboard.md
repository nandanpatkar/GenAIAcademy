...
# Run evaluations
async def main():
    report = await experiment.run_evaluations_async(my_agent_task)
...
-   [Strands Evals SDK Documentation](lc:user-guide/evals-sdk/quickstart)

## Related pages

- [Deploying Strands Agents to Amazon Bedrock AgentCore Runtime](lc:user-guide/deploy/deploy_to_bedrock_agentcore) (3 shared tags)
- [Python Deployment to Amazon Bedrock AgentCore Runtime](lc:user-guide/deploy/deploy_to_bedrock_agentcore/python) (3 shared tags)
- [TypeScript Deployment to Amazon Bedrock AgentCore Runtime](https://strandsagents.com/docs/user-guide/deploy/deploy_to_bedrock_agentcore/typescript/) (3 shared tags)
