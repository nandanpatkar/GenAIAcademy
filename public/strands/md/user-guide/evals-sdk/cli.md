...
-   `--data-store DIR` enables `LocalFileTaskResultStore` so cached task outputs short-circuit reruns. See [Result Caching](lc:user-guide/evals-sdk/how-to/result_caching) for details.
...
See [Detectors](lc:user-guide/evals-sdk/detectors) for the underlying API.
...
See [Experiment Generator](lc:user-guide/evals-sdk/experiment_generator) for the underlying API.
...
-   [Task Decorator](lc:user-guide/evals-sdk/how-to/eval_task) — the Python equivalent of `--agent`’s synthesized task wrapper, for use in scripts.
-   [Result Caching](lc:user-guide/evals-sdk/how-to/result_caching) — what `--data-store` writes and how cache hits work.
-   [Serialization](lc:user-guide/evals-sdk/how-to/serialization) — the on-disk shapes consumed by `validate`, `report`, and `generate --experiment`.
-   [Experiment Generator](lc:user-guide/evals-sdk/experiment_generator) — the API behind `strands-evals generate`.
-   [Detectors](lc:user-guide/evals-sdk/detectors) — the API behind `strands-evals diagnose`.
