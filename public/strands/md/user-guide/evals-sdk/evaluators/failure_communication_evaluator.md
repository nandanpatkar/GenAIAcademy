...
-   [**PartialCompletionEvaluator**](lc:user-guide/evals-sdk/evaluators/partial_completion_evaluator): Measures what fraction of goals were achieved despite failures
-   [**FaithfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/faithfulness_evaluator): Evaluates if responses are factually grounded
-   [**RefusalEvaluator**](lc:user-guide/evals-sdk/evaluators/refusal_evaluator): Detects when agents inappropriately refuse valid requests
...
- [Partial Completion Evaluator](lc:user-guide/evals-sdk/evaluators/partial_completion_evaluator) (3 shared tags)
