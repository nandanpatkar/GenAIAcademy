...
-   [**TrajectoryEvaluator**](lc:user-guide/evals-sdk/evaluators/trajectory_evaluator): Evaluates the sequence of actions/tools used
-   [**FaithfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/faithfulness_evaluator): Checks if responses are grounded in conversation history
-   [**HelpfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/helpfulness_evaluator): Specifically evaluates helpfulness from user perspective
-   [**GoalSuccessRateEvaluator**](lc:user-guide/evals-sdk/evaluators/goal_success_rate_evaluator): Evaluates if user goals were achieved
