...
-   **test\_pass**: Boolean indicating if the test passed
...
-   [**MultimodalOverallQualityEvaluator**](lc:user-guide/evals-sdk/evaluators/multimodal_overall_quality_evaluator): Likert-5 quality scoring
-   [**MultimodalCorrectnessEvaluator**](lc:user-guide/evals-sdk/evaluators/multimodal_correctness_evaluator): Strict binary factual correctness
-   [**MultimodalFaithfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/multimodal_faithfulness_evaluator): Strict binary hallucination detection against the image
-   [**MultimodalInstructionFollowingEvaluator**](lc:user-guide/evals-sdk/evaluators/multimodal_instruction_following_evaluator): Strict binary instruction compliance
-   [**OutputEvaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Text-only parent class with the same `evaluate()` contract

## Related pages

- [Multimodal Correctness Evaluator](lc:user-guide/evals-sdk/evaluators/multimodal_correctness_evaluator) (2 shared tags)
- [Multimodal Faithfulness Evaluator](lc:user-guide/evals-sdk/evaluators/multimodal_faithfulness_evaluator) (2 shared tags)
- [Multimodal Instruction Following Evaluator](lc:user-guide/evals-sdk/evaluators/multimodal_instruction_following_evaluator) (2 shared tags)
- [Multimodal Overall Quality Evaluator](lc:user-guide/evals-sdk/evaluators/multimodal_overall_quality_evaluator) (2 shared tags)
