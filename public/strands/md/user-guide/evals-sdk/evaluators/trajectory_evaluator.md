...
-   [**OutputEvaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Evaluates the quality of final outputs
-   [**ToolParameterAccuracyEvaluator**](lc:user-guide/evals-sdk/evaluators/tool_parameter_evaluator): Evaluates if tool parameters are correct
-   [**ToolSelectionAccuracyEvaluator**](lc:user-guide/evals-sdk/evaluators/tool_selection_evaluator): Evaluates if correct tools were selected
-   [**GoalSuccessRateEvaluator**](lc:user-guide/evals-sdk/evaluators/goal_success_rate_evaluator): Evaluates if overall goals were achieved
