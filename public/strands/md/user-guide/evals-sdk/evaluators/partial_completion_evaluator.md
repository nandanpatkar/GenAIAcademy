...
This evaluator operates at the **TRACE\_LEVEL**, evaluating the full conversation trace to assess progress across all task sub-steps.
...
-   [**GoalSuccessRateEvaluator**](lc:user-guide/evals-sdk/evaluators/goal_success_rate_evaluator): Binary goal achievement assessment
-   [**RecoveryStrategyEvaluator**](lc:user-guide/evals-sdk/evaluators/recovery_strategy_evaluator): Evaluates quality of recovery actions
-   [**FailureCommunicationEvaluator**](lc:user-guide/evals-sdk/evaluators/failure_communication_evaluator): Evaluates how well agents communicate failures
-   [**HelpfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/helpfulness_evaluator): Evaluates response helpfulness from user perspective
-   [**TrajectoryEvaluator**](lc:user-guide/evals-sdk/evaluators/trajectory_evaluator): Evaluates the sequence of actions taken

## Related Documentation

-   [Chaos Testing](lc:user-guide/evals-sdk/chaos_testing): Chaos testing overview and guide

## Related pages

- [Failure Communication Evaluator](lc:user-guide/evals-sdk/evaluators/failure_communication_evaluator) (3 shared tags)
- [Recovery Strategy Evaluator](lc:user-guide/evals-sdk/evaluators/recovery_strategy_evaluator) (3 shared tags)
- [Tool Simulation](lc:user-guide/evals-sdk/simulators/tool_simulation) (2 shared tags)
- [Chaos Testing](lc:user-guide/evals-sdk/chaos_testing) (2 shared tags)
- [Deterministic Evaluators](lc:user-guide/evals-sdk/evaluators/deterministic_evaluators) (1 shared tag)
- [Experiment Generator](lc:user-guide/evals-sdk/experiment_generator) (1 shared tag)
- [Simulators](lc:user-guide/evals-sdk/simulators) (1 shared tag)
- [Tool Parameter Accuracy Evaluator](lc:user-guide/evals-sdk/evaluators/tool_parameter_evaluator) (1 shared tag)
- [Tool Selection Accuracy Evaluator](lc:user-guide/evals-sdk/evaluators/tool_selection_evaluator) (1 shared tag)
- [Trajectory Evaluator](lc:user-guide/evals-sdk/evaluators/trajectory_evaluator) (1 shared tag)
