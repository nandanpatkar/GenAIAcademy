...
-   [**HarmfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/harmfulness_evaluator): Detect harmful content in responses
-   [**StereotypingEvaluator**](lc:user-guide/evals-sdk/evaluators/stereotyping_evaluator): Detect bias and stereotypical content
-   [**InstructionFollowingEvaluator**](lc:user-guide/evals-sdk/evaluators/instruction_following_evaluator): Verify explicit instructions are followed
