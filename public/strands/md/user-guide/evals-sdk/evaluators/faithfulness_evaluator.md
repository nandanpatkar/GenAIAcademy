...
-   [**OutputEvaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Evaluates overall output quality
-   [**ToolParameterAccuracyEvaluator**](lc:user-guide/evals-sdk/evaluators/tool_parameter_evaluator): Evaluates if tool parameters are grounded in context
