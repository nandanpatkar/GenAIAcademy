...
-   [**TrajectoryEvaluator**](lc:user-guide/evals-sdk/evaluators/trajectory_evaluator): Evaluates tool call sequences (single agent)
-   [**GoalSuccessRateEvaluator**](lc:user-guide/evals-sdk/evaluators/goal_success_rate_evaluator): Evaluates overall goal achievement
-   [**OutputEvaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Evaluates final output quality
-   [**HelpfulnessEvaluator**](lc:user-guide/evals-sdk/evaluators/helpfulness_evaluator): Evaluates individual response helpfulness
