...
-   [**OutputEvaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Evaluates overall output quality with custom criteria
-   [**GoalSuccessRateEvaluator**](lc:user-guide/evals-sdk/evaluators/goal_success_rate_evaluator): Evaluates if overall user goals were achieved
