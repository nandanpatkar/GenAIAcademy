...
-   [**CorrectnessEvaluator**](lc:user-guide/evals-sdk/evaluators/correctness_evaluator): Evaluates factual accuracy (complementary to instruction following)
-   [**OutputEvaluator**](lc:user-guide/evals-sdk/evaluators/output_evaluator): Flexible custom rubric evaluation
-   [**RefusalEvaluator**](lc:user-guide/evals-sdk/evaluators/refusal_evaluator): Detect when agents refuse to address prompts
-   [**CoherenceEvaluator**](lc:user-guide/evals-sdk/evaluators/coherence_evaluator): Assess logical consistency and reasoning

## Related pages

- [Prompt Engineering](lc:user-guide/safety-security/prompt-engineering) (2 shared tags)
- [Prompts](lc:user-guide/concepts/agents/prompts) (2 shared tags)
