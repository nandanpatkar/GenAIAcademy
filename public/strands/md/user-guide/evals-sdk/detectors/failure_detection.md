...
For a combined detect-and-analyze pipeline, use [`diagnose_session`](lc:user-guide/evals-sdk/detectors/diagnosis) instead.
...
-   [Root Cause Analysis](lc:user-guide/evals-sdk/detectors/root_cause_analysis): Analyze why failures happened
-   [Session Diagnosis](lc:user-guide/evals-sdk/detectors/diagnosis): Combined detection + RCA pipeline
-   [Detectors Overview](lc:user-guide/evals-sdk/detectors): High-level detectors guide
-   [Remote Trace Providers](lc:user-guide/evals-sdk/how-to/trace_providers): Fetch traces from production backends

## Related pages

- [Detectors](lc:user-guide/evals-sdk/detectors) (2 shared tags)
