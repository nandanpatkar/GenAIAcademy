...
- Basic familiarity with Strands Agents ([Quickstart](https://strandsagents.com/latest/documentation/docs/user-guide/quickstart/)). We recommend completing [`13-human-in-the-loop`](https://github.com/strands-agents/samples/tree/main/python/01-learn/13-human-in-the-loop) first for hooks fundamentals.
...
| File                                                       | Description                                                                                |
|------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| [plugins-in-strands.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/14-plugins/plugins-in-strands.ipynb)     | Single end-to-end notebook covering all four plugin concepts in five sections plus a recap. |
...
Then open [plugins-in-strands.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/14-plugins/plugins-in-strands.ipynb) and run cells top-to-bottom.

## Related Tutorials

- [`13-human-in-the-loop`](https://github.com/strands-agents/samples/tree/main/python/01-learn/13-human-in-the-loop) — hooks fundamentals; this tutorial assumes you have seen `HookProvider`.
- [`15-skills`](https://github.com/strands-agents/samples/tree/main/python/01-learn/15-skills) — `AgentSkills` is a real plugin you can install today; come back to this tutorial after that one to see how `AgentSkills` is built.
- [`16-hooks-lifecycle`](https://github.com/strands-agents/samples/tree/main/python/01-learn/16-hooks-lifecycle) — full event catalogue and writable fields.
