...
- Familiarity with Strands Agents basics [(see Tutorial 01)](https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent)
...
| File | Description |
|------|-------------|
| [structured-output.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/19-structured-output/structured-output.ipynb) | Interactive notebook covering the core structured output patterns |
...
1. Open the notebook: [structured-output.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/19-structured-output/structured-output.ipynb)
...
- Learn about [Memory](https://github.com/strands-agents/samples/tree/main/python/01-learn/06-memory) to persist agent memory across sessions
- Explore [Agents as Tools](https://github.com/strands-agents/samples/tree/main/python/01-learn/10-agents-as-tools) to compose structured output agents into larger systems
- Try [Graph Workflows](https://github.com/strands-agents/samples/tree/main/python/01-learn/12-graph) to build multi-step pipelines with structured data flowing between nodes
