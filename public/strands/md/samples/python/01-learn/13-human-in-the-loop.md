...
![Architecture Pattern 2](/strands/images/strands github/samples/python/01-learn/13-human-in-the-loop/images/pattern-1.png)
![Architecture Pattern 3](/strands/images/strands github/samples/python/01-learn/13-human-in-the-loop/images/pattern-2.png)
...
| File | Description |
|------|-------------|
| [strands_hitl.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/13-human-in-the-loop/strands_hitl.ipynb) | Interactive notebook demonstrating three HITL patterns |

## What You'll Learn

The [strands_hitl.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/13-human-in-the-loop/strands_hitl.ipynb) notebook in this directory covers:
...
1. Open the notebook: [strands_hitl.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/13-human-in-the-loop/strands_hitl.ipynb)
...
- Learn about [Memory](https://github.com/strands-agents/samples/tree/main/python/01-learn/06-memory) for long-running workflows
- Review [Observability](https://github.com/strands-agents/samples/tree/main/python/01-learn/08-observability) to monitor HITL interactions
