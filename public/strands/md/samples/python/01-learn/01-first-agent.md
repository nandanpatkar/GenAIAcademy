...
![Architecture](/strands/images/strands github/samples/python/01-learn/01-first-agent/images/agent_with_tools.png)
...
| Path | Description |
|------|-------------|
| [01-first-agent.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent/01-first-agent.ipynb) | Quickstart notebook: create your first agent, add built-in and custom tools, invoke tools directly, configure logging, choose a model provider, and assemble a RecipeBot use case |
| [recipe-bot-cli/](https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent/recipe-bot-cli) | The RecipeBot as a standalone command-line script |

The command-line script runs the RecipeBot interactively:

![RecipeBot](/strands/images/strands github/samples/python/01-learn/01-first-agent/images/interactive_recipe_agent.png)
...
2. **Run the notebook:** open [`01-first-agent.ipynb`](https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent/01-first-agent.ipynb) and run the cells in order. It covers:
