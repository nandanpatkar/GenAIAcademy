...
|----------|-------------|
| [01-single-agent-persistence.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/20-session-management/01-single-agent-persistence.ipynb) | Baseline failure → FileSessionManager → S3 backend → custom DynamoDB backend |
| [02-multi-agent-persistence.ipynb](https://github.com/strands-agents/samples/tree/main/python/01-learn/20-session-management/02-multi-agent-persistence.ipynb) | Session persistence with Swarm and Graph patterns |
