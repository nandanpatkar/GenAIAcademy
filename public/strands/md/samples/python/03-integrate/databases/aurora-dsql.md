...
![architecture](/strands/images/strands github/samples/python/03-integrate/databases/aurora-dsql/architecture.png)
...
2. Set up AWS credentials in `.env` using [.env.example](https://github.com/strands-agents/samples/tree/main/python/03-integrate/databases/aurora-dsql/.env.example).
