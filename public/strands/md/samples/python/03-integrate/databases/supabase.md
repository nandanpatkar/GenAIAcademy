...
![Agent architecture](/strands/images/strands github/samples/python/03-integrate/databases/supabase/assets/architecture1.png)

![Solution architecture](/strands/images/strands github/samples/python/03-integrate/databases/supabase/assets/architecture2.png)                                  
...
Run the notebook [`supabase-integration.ipynb`](https://github.com/strands-agents/samples/tree/main/python/03-integrate/databases/supabase/supabase-integration.ipynb) to explore the Supabase MCP features.
