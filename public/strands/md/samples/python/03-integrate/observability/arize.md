...
1. Clone the repository:
   ...
   cd python/03-integrate/observability/arize
   ```
...
1. **Project Traces**  
   ![1. Project Traces](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/project_traces.png)

2. **Filtering Traces**  
   ![2. Filter Traces](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/filter_traces.png)

3. **Filtering by Model ID**  
   ![3. Filter by Model ID](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/filter_trace_model_ID.png)

4. **Trace Details**  
   ![4. Trace Details](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/trace_arize.png)

5. **Execution Graph**  
   ![5. Graph View](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/graph.png)

6. **Inspecting Execution Paths**  
   ![6. Inspect Path](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/inspect_path.png)

7. **Session Information**  
   ![7. View Sessions](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/view_sessions.png)

### Monitoring

8. **Pre-built Monitors**  
   ![8. Pre-built Monitors](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/prebuilt_monitors.png)

9. **Monitor View**  
   ![9. Monitor Explained](/strands/images/strands github/samples/python/03-integrate/observability/arize/images/monitor_explained.png)
