...
![Architecture](/strands/images/strands github/samples/python/02-deploy/04-agentcore-multi-agent/01-a2a-orchestration/images/architecture.png)
...
|----------|-------|-------------|
| [01-a2a-server-product-agent.ipynb](https://github.com/strands-agents/samples/tree/main/python/02-deploy/04-agentcore-multi-agent/01-a2a-orchestration/01-a2a-server-product-agent.ipynb) | Product Agent | A2A server with [DummyJSON](https://dummyjson.com) API tools for product catalog search |
| [02-a2a-server-order-agent.ipynb](https://github.com/strands-agents/samples/tree/main/python/02-deploy/04-agentcore-multi-agent/01-a2a-orchestration/02-a2a-server-order-agent.ipynb) | Order Agent | A2A server with MCP integration for Amazon DynamoDB order lookup |
| [03-a2a-client-orchestrator-agent.ipynb](https://github.com/strands-agents/samples/tree/main/python/02-deploy/04-agentcore-multi-agent/01-a2a-orchestration/03-a2a-client-orchestrator-agent.ipynb) | Orchestrator | User-facing HTTP endpoint that routes queries to specialist agents via A2A |
