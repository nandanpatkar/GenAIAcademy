...
![architecture](/strands/images/strands github/samples/python/04-industry-use-cases/software-engineering/aws-assistant-mcp/architecture.png)
...
4. Set up AWS credentials in `.env` using [.env.example](https://github.com/strands-agents/samples/tree/main/python/04-industry-use-cases/software-engineering/aws-assistant-mcp/.env.example).
