...
![architecture](/strands/images/strands github/samples/python/04-industry-use-cases/software-engineering/data-warehouse-optimizer/architecture.png)
...
- Specify the region using .env file, create the file using [.env.template](https://github.com/strands-agents/samples/tree/main/python/04-industry-use-cases/software-engineering/data-warehouse-optimizer/.env.template). Default region is `us-east-1`.
