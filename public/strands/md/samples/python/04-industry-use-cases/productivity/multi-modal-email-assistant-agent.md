...
![Architecture](/strands/images/strands github/samples/python/04-industry-use-cases/productivity/multi-modal-email-assistant-agent/images/architecture.png)
...
1. Run the notebooks in [Multi-modal-data-ingest/audio-video-rag/](https://github.com/strands-agents/samples/tree/main/python/04-industry-use-cases/productivity/multi-modal-email-assistant-agent/Multi-modal-data-ingest/audio-video-rag) folder to process audio files
