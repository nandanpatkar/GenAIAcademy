...
![architecture](/strands/images/strands github/samples/python/04-industry-use-cases/healthcare/medical-document-processing-assistant/images/architecture.png)
...
2. Set up AWS credentials in `.env` using [.env.example](https://github.com/strands-agents/samples/tree/main/python/04-industry-use-cases/healthcare/medical-document-processing-assistant/.env.example).
