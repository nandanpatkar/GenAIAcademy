...
![architecture](/strands/images/strands github/samples/python/04-industry-use-cases/marketing/startup-advisor-mcp/architecture.png)
...
3. Create .env file with [.env.example](https://github.com/strands-agents/samples/tree/main/python/04-industry-use-cases/marketing/startup-advisor-mcp/.env.example).
