...
| --- | --- | --- |
| Fix a bug | Check for existing issues, submit a PR with tests that verify your fix | [SDK](lc:contribute/contributing/core-sdk) |
| Add a new feature | For small changes, open an issue first. For larger features, write a design document to align on direction | [Feature Proposals](lc:contribute/contributing/feature-proposals) |
| Improve the docs | Fix typos, clarify explanations, add examples, or write new guides | [Documentation](lc:contribute/contributing/documentation) |
...
| I want to… | What it involves | Guide |
| --- | --- | --- |
| Publish an extension | Package your component and publish it so others can use it | [Publishing Extensions](lc:contribute/contributing/extensions) |

## Community resources

-   [Community Catalog](lc:community/community-packages) — Discover community-built extensions
