...
6.  **Implement** — Follow the [SDK contribution process](lc:contribute/contributing/core-sdk)
7.  **Reference the design** — Link to the approved design document in your implementation PR

## Design document template

See the full template in the [designs folder README](https://github.com/strands-agents/harness-sdk/blob/main/team/designs/README.md#design-document-template).
