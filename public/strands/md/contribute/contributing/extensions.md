...
Your package can get listed in our [community catalog](lc:community/community-packages), making it discoverable to developers looking for exactly what you built.
...
| --- | --- | --- |
| **Tools** | Add capabilities to agents—call APIs, access databases, interact with services | [Custom tools](lc:user-guide/concepts/tools/custom-tools) |
| **Model providers** | Integrate LLM APIs beyond the built-in providers | [Custom model providers](lc:user-guide/concepts/model-providers/custom_model_provider) |
| **Plugins** | Extend or modify agent behavior during lifecycle events such as invocations, tool calls, and model calls | [Plugins](lc:user-guide/concepts/plugins) |
| **Interventions** | Add composable control handlers for authorization, guardrails, and steering with typed actions | [Interventions](lc:user-guide/concepts/agents/interventions) |
| **Session managers** | Persist conversations to external storage for resumption or sharing | [Session management](lc:user-guide/concepts/agents/session-management) |
| **Conversation managers** | Control how message history grows—trim old messages or summarize context | [Conversation management](lc:user-guide/concepts/agents/conversation-management) |
| **Storage** | Persist raw bytes under string keys for session snapshots, context offloading, and other durable data | [Storage backends](lc:user-guide/concepts/plugins/context-offloader#storage-backends) |
...
Once you publish, the next step is getting other developers to discover and use your package. See the [Get Featured guide](lc:community/get-featured) for how to add GitHub topics and get listed in our community catalog.
