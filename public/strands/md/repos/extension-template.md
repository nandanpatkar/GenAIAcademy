...
|------------|----------------------------|------------------|----------------------------------------------------------|
| Python     | [`python/`](https://github.com/strands-agents/extension-template/tree/main/python)      | PyPI             | [`strands-agents`](https://pypi.org/project/strands-agents/) |
| TypeScript | [`typescript/`](https://github.com/strands-agents/extension-template/tree/main/typescript) | npm           | [`@strands-agents/sdk`](https://www.npmjs.com/package/@strands-agents/sdk) |
...
3. Open the corresponding subdirectory and follow its README:
   - Python → [`python/README.md`](https://github.com/strands-agents/extension-template/tree/main/python/README.md)
   - TypeScript → [`typescript/README.md`](https://github.com/strands-agents/extension-template/tree/main/typescript/README.md)
...
|---------------|-------------------------------------------------|--------------|
| `python-v*`   | [`publish-python.yml`](https://github.com/strands-agents/extension-template/tree/main/.github/workflows/publish-python.yml)         | PyPI         |
| `typescript-v*` | [`publish-typescript.yml`](https://github.com/strands-agents/extension-template/tree/main/.github/workflows/publish-typescript.yml) | npm          |
...
Apache 2.0 — see [LICENSE](https://github.com/strands-agents/extension-template/tree/main/LICENSE) for details.
