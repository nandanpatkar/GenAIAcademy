...
[Explore Python tutorials →](https://github.com/strands-agents/samples/tree/main/python/01-learn)
...
[Explore TypeScript tutorials →](https://github.com/strands-agents/samples/tree/main/typescript/01-learn)
...
- **[01-learn](https://github.com/strands-agents/samples/tree/main/python/01-learn)** - SDK tutorials covering fundamentals, multi-agent systems, and streaming
- **[02-deploy](https://github.com/strands-agents/samples/tree/main/python/02-deploy)** - Deployment patterns for Lambda, Fargate, and AgentCore
- **[03-integrate](https://github.com/strands-agents/samples/tree/main/python/03-integrate)** - Integrations with AWS services, databases, and third-party tools
- **[04-industry-use-cases](https://github.com/strands-agents/samples/tree/main/python/04-industry-use-cases)** - Industry applications (finance, healthcare, retail, productivity, etc.)
- **[05-technical-use-cases](https://github.com/strands-agents/samples/tree/main/python/05-technical-use-cases)** - Architectural patterns including Agentic RAG
- **[06-evaluate](https://github.com/strands-agents/samples/tree/main/python/06-evaluate)** - Evaluation tutorials and testing patterns
- **[07-ux-demos](https://github.com/strands-agents/samples/tree/main/python/07-ux-demos)** - Full-stack applications with user interfaces
- **[08-edge](https://github.com/strands-agents/samples/tree/main/python/08-edge)** - Edge device integrations including physical AI and robotics
...
- **[01-learn](https://github.com/strands-agents/samples/tree/main/typescript/01-learn)** - SDK tutorials for the TypeScript SDK
- **[02-deploy](https://github.com/strands-agents/samples/tree/main/typescript/02-deploy)** - Deployment patterns for AgentCore

## Contributing ❤️

We welcome contributions! See our [Contributing Guide](https://github.com/strands-agents/samples/tree/main/CONTRIBUTING.md) for details on:
...
This project is licensed under the Apache License 2.0 - see the [LICENSE](https://github.com/strands-agents/samples/tree/main/LICENSE) file for details.

## Security

See [CONTRIBUTING](https://github.com/strands-agents/samples/tree/main/CONTRIBUTING.md#security-issue-notifications) for more information.
