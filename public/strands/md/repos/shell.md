...
If you bypass any of these, report it. See [SECURITY.md](https://github.com/strands-agents/shell/tree/main/SECURITY.md).
...
See [CONTRIBUTING.md](https://github.com/strands-agents/shell/tree/main/CONTRIBUTING.md). Bug reports and design questions are just as useful as PRs.
...
If you find a security issue, report it privately instead of opening a public issue. Bypasses of filesystem mediation, SSRF protection, or credential injection qualify. See [SECURITY.md](https://github.com/strands-agents/shell/tree/main/SECURITY.md).
