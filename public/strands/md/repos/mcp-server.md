...
We welcome contributions! See our [Contributing Guide](https://github.com/strands-agents/mcp-server/tree/main/CONTRIBUTING.md) for details on:
...
This project is licensed under the Apache License 2.0 - see the [LICENSE](https://github.com/strands-agents/mcp-server/tree/main/LICENSE) file for details.

## Security

See [CONTRIBUTING](https://github.com/strands-agents/mcp-server/tree/main/CONTRIBUTING.md#security-issue-notifications) for more information.
