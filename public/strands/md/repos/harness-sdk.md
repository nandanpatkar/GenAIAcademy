...
The [Python SDK README](https://github.com/strands-agents/harness-sdk/tree/main/strands-py) covers tools, model providers, MCP, and bidirectional streaming.
...
More in the [TypeScript SDK README](https://github.com/strands-agents/harness-sdk/tree/main/strands-ts), including Zod-typed tools, structured output, and multi-agent patterns.
...
The docs themselves live in this monorepo under [`site/`](https://github.com/strands-agents/harness-sdk/tree/main/site), and doc PRs are welcome alongside code changes.
...
We welcome contributions! See our [Contributing Guide](https://github.com/strands-agents/harness-sdk/tree/main/CONTRIBUTING.md) for details on:
...
This project is licensed under the Apache License 2.0 - see the [LICENSE.APACHE](https://github.com/strands-agents/harness-sdk/tree/main/LICENSE.APACHE) file for details.

## Security

See [CONTRIBUTING](https://github.com/strands-agents/harness-sdk/tree/main/CONTRIBUTING.md#security-issue-notifications) for more information.
