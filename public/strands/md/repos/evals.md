...
- **Red Team Evaluation**: Adversarial safety testing with built-in attack strategies (Crescendo, GOAT, PAIR, BadLikertJudge, SequentialBreak); see [src/strands_evals/experimental/redteam/README.md](https://github.com/strands-agents/evals/tree/main/src/strands_evals/experimental/redteam/README.md)
...
Available effects: `Timeout`, `NetworkError`, `ExecutionError`, `ValidationError` (cancel the tool call); `TruncateFields`, `RemoveFields`, `CorruptValues` (corrupt the response). Pair with chaos-aware evaluators in `strands_evals.evaluators.chaos` (`FailureCommunicationEvaluator`, `PartialCompletionEvaluator`, `RecoveryStrategyEvaluator`). For the full authoring guide see [`SKILL.md`](https://github.com/strands-agents/evals/tree/main/SKILL.md#chaos-testing-deterministic-fault-injection).
...
We welcome contributions! See our [Contributing Guide](https://github.com/strands-agents/evals/tree/main/CONTRIBUTING.md) for details on:
- Development setup
...
This project is licensed under the Apache License 2.0 - see the [LICENSE](https://github.com/strands-agents/evals/tree/main/LICENSE) file for details.

## Security

See [CONTRIBUTING](https://github.com/strands-agents/evals/tree/main/CONTRIBUTING.md#security-issue-notifications) for more information.
