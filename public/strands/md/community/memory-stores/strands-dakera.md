...
-   **`DakeraMemoryStore`** — a [`MemoryStore`](lc:user-guide/concepts/memory/overview) that plugs into the agent loop via a `MemoryManager` (Strands ≥ 1.45), with automatic memory injection and extraction.
