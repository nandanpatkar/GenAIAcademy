...
> [!NOTE]
>
> This guide is adapted for AG-UI. For general AgentCore deployment documentation, see [Deploy to Bedrock AgentCore](lc:user-guide/deploy/deploy_to_bedrock_agentcore).
