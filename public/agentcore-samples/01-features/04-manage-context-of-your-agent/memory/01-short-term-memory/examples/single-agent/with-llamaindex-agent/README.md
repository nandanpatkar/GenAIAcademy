...
The long-term counterparts live in [`../../../../02-long-term-memory/examples/single-agent/with-llamaindex-agent/03-memory-tool/`](../../../../02-long-term-memory/examples/single-agent/with-llamaindex-agent/03-memory-tool/).
