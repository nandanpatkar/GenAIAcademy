...
For a reference setup, see the [OTel collector example](lc:langsmith/langsmith-collector#logs).
...
For a reference setup, see the [OTel collector example](lc:langsmith/langsmith-collector#metrics).
...
For a reference setup, see the [OTel collector example](lc:langsmith/langsmith-collector#traces).
