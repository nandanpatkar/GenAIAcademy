...
If you are ready to install, start with the [deployment walkthrough](lc:langsmith/self-host-terraform-aws-deploy).
...
![LangSmith on AWS service layout](/langchain/images/images/self-hosted-terraform/aws-architecture.png)
...
For production sizing recommendations, see the [scaling guide](lc:langsmith/self-host-scale) and the [AWS deployment guide](lc:langsmith/self-host-terraform-aws-deploy#cluster-sizing-reference).
