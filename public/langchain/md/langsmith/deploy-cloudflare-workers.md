...
1. Swap in a [durable checkpointer](lc:oss/python/langgraph/checkpointers#checkpointer-libraries) (for example Postgres via Hyperdrive, or a custom DO-backed store).
