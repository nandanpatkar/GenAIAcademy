...
![Sandboxes snapshots page](/langchain/images/images/langsmith/sandboxes/sb-snapshots.png)
...
- [Create sandboxes from snapshots with the SDK](lc:langsmith/sandbox-sdk)
- [Expose HTTP services with Service URLs](lc:langsmith/sandbox-service-urls)
- [Inject credentials via the Auth proxy](lc:langsmith/sandbox-auth-proxy)
