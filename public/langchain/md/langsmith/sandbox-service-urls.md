...
![Service URLs view](/langchain/images/images/langsmith/sandboxes/sb-service-feature.png)
...
Use **service URLs** for HTTP services you want to access from a browser or share with others. Use **[TCP tunnels](lc:langsmith/sandbox-sdk#tcp-tunnels-python)** for non-HTTP protocols (like `psql` or `redis-cli`) or when you need local-only access.
