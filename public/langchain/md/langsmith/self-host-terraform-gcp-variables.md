...
For the end-to-end install, refer to the [deploy guide](lc:langsmith/self-host-terraform-gcp-deploy). For how the modules fit together, refer to the [architecture reference](lc:langsmith/self-host-terraform-gcp-architecture).
