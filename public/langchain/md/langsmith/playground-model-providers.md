The [Playground](lc:langsmith/prompt-engineering-concepts#playground) supports a wide range of model providers. You can select a provider, configure your preferred settings, and save these configurations to reuse across multiple prompts.
...
![](/langchain/images/images/providers/light/anthropic.svg)

        
![](/langchain/images/images/providers/dark/anthropic.svg)
...
![](/langchain/images/images/providers/light/microsoft.svg)

        
![](/langchain/images/images/providers/dark/microsoft.svg)
...
![](/langchain/images/images/providers/light/deepseek.svg)

        
![](/langchain/images/images/providers/dark/deepseek.svg)
...
![](/langchain/images/images/providers/light/fireworks.svg)

        
![](/langchain/images/images/providers/dark/fireworks.svg)
...
![](/langchain/images/images/providers/light/gemini.svg)

        
![](/langchain/images/images/providers/dark/gemini.svg)
...
![](/langchain/images/images/providers/light/groq.svg)

        
![](/langchain/images/images/providers/dark/groq.svg)
...
![](/langchain/images/images/providers/light/mistral.svg)

        
![](/langchain/images/images/providers/dark/mistral.svg)
...
![](/langchain/images/images/providers/light/openai.svg)

        
![](/langchain/images/images/providers/dark/openai.svg)
...
![](/langchain/images/images/providers/light/xai.svg)

        
![](/langchain/images/images/providers/dark/xai.svg)

        <span className="font-semibold">XAI</span>
    </a>

For details on creating and managing model configurations, refer to the [Configure prompt settings](lc:langsmith/managing-model-configurations) page.
...
> [!NOTE]
>
> **Not applicable for [self-hosted LangSmith](lc:langsmith/self-hosted).** Use Access Keys (or the Bedrock API Key) instead.
...
3. In the LangSmith Playground, open the Bedrock provider's secrets configuration by clicking the **Key** icon (the IAM Trusted Entity option is not available in the model configuration dropdown itself). Then expand the **IAM Trusted Entity** section and enter the ARN of the role you created.
    ...
    ![Bedrock secrets and API keys configuration with the IAM Trusted Entity section](/langchain/images/images/langsmith/bedrock-secrets-config.png)
...
- **API key**: stored as a [workspace secret](lc:langsmith/administration-overview#workspaces) and forwarded as `Authorization: Bearer <key>`.
- **None**: for unauthenticated local endpoints (for example, Ollama on `localhost`).
- **OAuth2 `client_credentials`**: stored on the model configuration. LangSmith mints a short-lived bearer at request time and refreshes it before expiry. See [OAuth client credentials](lc:langsmith/model-configurations#oauth-client-credentials).
