LangSmith provides integrations with [Vitest](https://vitest.dev/) and [Jest](https://jestjs.io/) that allow JavaScript and TypeScript developers to define their [datasets](lc:langsmith/evaluation-concepts#datasets) and evaluate using familiar syntax.

![Jest/Vitest reporter output](/langchain/images/langsmith/images/jest-vitest-reporter-output.png)
...
> [!NOTE]
>
> The Python SDK has an analogous [pytest integration](lc:langsmith/pytest).
...
[
 {
  "label": "yarn",
  "lang": "bash",
  "code": "yarn add -D vitest dotenv"
 },
 {
  "label": "npm",
  "lang": "bash",
  "code": "npm install -D vitest dotenv"
 },
 {
  "label": "pnpm",
  "lang": "bash",
  "code": "pnpm add -D vitest dotenv"
 }
]
```
...
[
 {
  "label": "yarn",
  "lang": "bash",
  "code": "yarn add langsmith openai"
 },
 {
  "label": "npm",
  "lang": "bash",
 ...
 },
 {
  "label": "pnpm",
  "lang": "bash",
  "code": "pnpm add langsmith openai"
 }
]
```
...
[
 {
  "label": "yarn",
  "lang": "bash",
  "code": "yarn add -D jest dotenv"
 },
 {
  "label": "npm",
  "lang": "bash",
  "code": "npm install -D jest dotenv"
 },
 {
  "label": "pnpm",
  "lang": "bash",
  "code": "pnpm add -D jest dotenv"
 }
]
```
...
* Creates a [dataset](lc:langsmith/evaluation-concepts#datasets) with the same name as the name passed to `ls.describe()` in LangSmith if it does not exist.
* Creates an [example](lc:langsmith/evaluation-concepts#datasets) in the dataset for each input and expected output passed into a test case if a matching one does not already exist.
* Creates a new [experiment](lc:langsmith/evaluation-concepts#experiment) with one result for each test case.
...
![Experiment](/langchain/images/langsmith/images/simple-vitest.png)
...
Instead of defining [examples](lc:langsmith/evaluation-concepts#examples) inline, you can run tests against an existing dataset in LangSmith:
