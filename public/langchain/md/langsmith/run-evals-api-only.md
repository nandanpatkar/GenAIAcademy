...
After running your [experiments](lc:langsmith/evaluation-concepts#experiment), you'll typically want to evaluate the results by adding feedback scores. This allows you to track metrics like correctness, accuracy, or any custom evaluation criteria.
...
For more information, check out [How to run a pairwise evaluation](lc:langsmith/evaluate-pairwise).
