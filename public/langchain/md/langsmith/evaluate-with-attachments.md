...
When adding runs to a LangSmith dataset, attachments can be selectively propagated from the source run to the destination example. To learn more, please see [Manage datasets in application](lc:langsmith/manage-datasets-in-application#manually-from-a-tracing-project).

![Add trace with attachments to dataset](/langchain/images/langsmith/images/add-trace-with-attachments-to-dataset.png)
...
![Create example with attachments](/langchain/images/langsmith/images/create-example-with-attachments.png)

Once uploaded, you can view examples with attachments in the LangSmith UI. Each attachment will be rendered with a preview for easy inspection. ![Attachments with examples](/langchain/images/langsmith/images/attachments-with-examples.png)
...
![Adding multimodal variable](/langchain/images/langsmith/images/adding-multimodal-variable.gif.poster.png "heavy:18.9:https://docs.langchain.com/langsmith/images/adding-multimodal-variable.gif")
...
![Create evaluator modal with an audio attachment selected for output variable.](/langchain/images/langsmith/images/evaluator-attach-file-light.png)


    
![Create evaluator modal with an audio attachment selected for output variable.](/langchain/images/langsmith/images/evaluator-attach-file-dark.png)
...
![Attachment editing](/langchain/images/langsmith/images/attachment-editing.gif.poster.png "heavy:12.5:https://docs.langchain.com/langsmith/images/attachment-editing.gif")
...
The evaluator below uses an LLM to judge if the reasoning and the answer are consistent. To learn more about how to define llm-based evaluators, please see [How to define an LLM-as-a-judge evaluator](lc:langsmith/llm-as-judge).
...
As with existing examples, datasets are versioned when you update them with attachments. Therefore, you can navigate to the dataset version history to see the changes made to each example. To learn more, please see [Create and manage datasets in the UI](lc:langsmith/manage-datasets-in-application).
