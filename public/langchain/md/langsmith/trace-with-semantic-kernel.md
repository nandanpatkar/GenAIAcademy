...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langsmith semantic-kernel opentelemetry-instrumentation-openai"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langsmith semantic-kernel opentelemetry-instrumentation-openai"
 }
]
```
