...
![The prompt interface with the + Tool button following the editing boxes.](/langchain/images/langsmith/images/add-tool-light.png)


![The prompt interface with the + Tool button following the editing boxes.](/langchain/images/langsmith/images/add-tool-dark.png)
...
2. When the model calls the tool, the Playground will display the response.
    ...
    ![Web search tool](/langchain/images/langsmith/images/web-search-tool.gif.poster.png "heavy:7.5:https://docs.langchain.com/langsmith/images/web-search-tool.gif")
...
![Custom tool](/langchain/images/langsmith/images/custom-tool.gif.poster.png "heavy:5.7:https://docs.langchain.com/langsmith/images/custom-tool.gif")
...
![Manage tools with a list of available tools, Enabled switch, and edit functionality.](/langchain/images/langsmith/images/tool-registry-manage-light.png)


![Manage tools with a list of available tools, Enabled switch, and edit functionality.](/langchain/images/langsmith/images/tool-registry-manage-dark.png)
...
![Select tools from the Tool Choice Settings tab.](/langchain/images/langsmith/images/tool-choice-light.png)


![Select tools from the Tool Choice Settings tab.](/langchain/images/langsmith/images/tool-choice-dark.png)
