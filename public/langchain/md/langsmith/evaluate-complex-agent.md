...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -U langgraph \"langchain[openai]\""
 },
 {
  "label": "uv",
  "lang": "bash",
...
![Chinook DB](/langchain/images/langsmith/images/chinook-diagram.png)
...
![Refund graph](/langchain/images/langsmith/images/refund-graph.png)
...
![QA Graph](/langchain/images/langsmith/images/qa-graph.png)
...
![graph](/langchain/images/langsmith/images/agent-tutorial-graph.png)
...
We'll create a custom [LLM-as-judge](lc:langsmith/evaluation-concepts#llm-as-judge) evaluator that uses another model to compare our agent's output on each example to the reference response, and judge if they're equivalent or not:
