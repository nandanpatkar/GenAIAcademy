...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langsmith autogen-agentchat autogen-ext opentelemetry-instrumentation-openai"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langsmith autogen-agentchat autogen-ext opentelemetry-instrumentation-openai"
 }
]
```
