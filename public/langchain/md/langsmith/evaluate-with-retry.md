When running [evaluations](lc:langsmith/evaluation-concepts#evaluation-lifecycle) on large [datasets](lc:langsmith/evaluation-concepts#datasets), you may encounter failures on a small subset of examples due to rate limits, network issues, or other transient errors. Rather than re-running the entire evaluation, you can identify and retry only the failed examples on an [experiment](lc:langsmith/evaluation-concepts#experiment).
...
* [Experiment configuration](lc:langsmith/experiment-configuration)
* [Evaluate existing experiment](lc:langsmith/evaluate-existing-experiment)
