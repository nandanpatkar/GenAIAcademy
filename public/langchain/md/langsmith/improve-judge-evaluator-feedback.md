...
- A [dataset](lc:langsmith/evaluation-concepts#datasets) with at least one [experiment](lc:langsmith/evaluation-concepts#experiment).
- You'll need to upload or create datasets via the [SDK](lc:langsmith/manage-datasets-programmatically#create-a-dataset) or the [UI](lc:langsmith/manage-datasets-in-application#create-a-dataset-and-add-examples) and run an experiment via the [SDK](lc:langsmith/evaluate-llm-application#run-the-evaluation) or the [Playground](lc:langsmith/run-evaluation-from-playground).

### Online evaluations

- An application that’s already sending traces to LangSmith.
- Configure this with one of the [tracing integrations](lc:langsmith/observability-concepts) to start.
...
Select one or more experiments (or runs) to send for human labeling. This will add runs to an [annotation queue](lc:langsmith/annotation-queues).

![Add to evaluator queue](/langchain/images/langsmith/images/add-to-evaluator-queue.gif.poster.png "heavy:17.2:https://docs.langchain.com/langsmith/images/add-to-evaluator-queue.gif")
...
![Evaluator Playground](/langchain/images/langsmith/images/evaluator-pg.gif.poster.png "heavy:8.8:https://docs.langchain.com/langsmith/images/evaluator-pg.gif")
...
![Enable reasoning](/langchain/images/langsmith/images/enable-reasoning.gif.poster.png "heavy:10.7:https://docs.langchain.com/langsmith/images/enable-reasoning.gif")
