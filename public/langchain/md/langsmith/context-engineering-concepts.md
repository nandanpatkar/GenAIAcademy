...
The [Context Hub](lc:langsmith/use-the-context-hub) is your agents' long-term context store. It tracks every change as a commit and supports versioning, sharing, and continuous improvement.
...
The **Context Hub** is designed for teams. Every repo lives in a [workspace](lc:langsmith/administration-overview#workspaces), and access depends on workspace permissions plus repo visibility:
...
- [Use the Context Hub](lc:langsmith/use-the-context-hub) to create your first skill or agent.
