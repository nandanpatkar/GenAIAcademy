...
Once configured, you will need to update your LangSmith installation. You can follow the [upgrade guide](lc:langsmith/self-host-upgrades). If everything is configured correctly, your LangSmith instance should now be accessible via the Ingress. You can run the following to check that your secrets are being used correctly:
