...
![Tracing project settings showing custom output rendering configuration](/langchain/images/langsmith/images/tracing-project-custom-output-rendering-settings.png)
...
![Dataset page with three-dot menu showing Custom Output Rendering option](/langchain/images/langsmith/images/custom-output-rendering-menu.png)
...
![Custom Output Rendering modal with fields filled in](/langchain/images/langsmith/images/custom-output-rendering-modal.png)

### For annotation queues

To configure custom output rendering for an annotation queue:

![Annotation queue settings showing custom output rendering configuration](/langchain/images/langsmith/images/annotation-queue-custom-output-rendering-settings.png)
...
![Experiment comparison view showing custom rendering](/langchain/images/langsmith/images/custom-output-rendering-experiment-comparison.png)

-   **Run detail panes**: When viewing runs that are associated with a dataset:

![Run detail pane showing custom rendering](/langchain/images/langsmith/images/custom-output-rendering-run-details.png)

-   **Annotation queues**: When reviewing runs in annotation queues:

![Annotation queue showing custom rendering](/langchain/images/langsmith/images/custom-output-rendering-annotation-queue.png)
