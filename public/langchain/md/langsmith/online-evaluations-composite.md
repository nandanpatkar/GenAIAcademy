[Online evaluations](lc:langsmith/evaluation-concepts#online-evaluations) provide real-time feedback on your production [traces](lc:langsmith/observability-concepts#traces). This is useful to continuously monitor the performance of your application: to identify issues, measure improvements, and ensure consistent quality over time.

[**Composite evaluators**](lc:langsmith/composite-evaluators-ui) are a way to combine multiple evaluator scores into a single [score](lc:langsmith/evaluation-concepts#evaluator-outputs). This is useful when you want to evaluate multiple aspects of your application and combine the results into a single result.
