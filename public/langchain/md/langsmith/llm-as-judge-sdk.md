...
This guide shows you how to define an [LLM-as-a-judge evaluator](lc:langsmith/evaluation-concepts#llm-as-judge) for [offline evaluation](lc:langsmith/evaluation-concepts#offline-evaluations) using the [LangSmith SDK](https://reference.langchain.com/python/langsmith/observability/sdk).


> [!TIP]
>
> For a quick start, use [openevals](lc:langsmith/openevals), which provides ready-to-use LLM-as-a-judge evaluators.
...
For more information on how to write a custom evaluator, refer to [How to define a code evaluator (SDK)](lc:langsmith/code-evaluator-sdk).
