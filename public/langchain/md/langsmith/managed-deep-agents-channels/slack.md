...
For the channel model and current limits, see [Channels](lc:langsmith/managed-deep-agents-channels/index).

## Prerequisites

- A Managed Deep Agents project with a root [identity](lc:langsmith/managed-deep-agents-identity) declaration (`channels/` requires identity).
...
![Slack App Credentials section showing App ID, Client ID, masked Client Secret, and masked Signing Secret](/langchain/images/langsmith/images/mda-slack-app-credentials.png)
...
![Slack Event Subscriptions page showing Enable Events on, a verified Request URL ending in /channels/slack/events, and bot events app_mention, message.channels, and message.im](/langchain/images/langsmith/images/mda-slack-event-subscriptions.png)
...
![Slack Bot Token Scopes listing app_mentions:read, channels:history, chat:write, and im:history](/langchain/images/langsmith/images/mda-slack-bot-token-scopes.png)


## Deploy and smoke-test

1. Put Slack secrets in `.env` and ensure [identity](lc:langsmith/managed-deep-agents-identity) is declared.
...
![Slack Redirect URLs showing https://…/identity/slack/callback saved for Connect-with-Slack OAuth](/langchain/images/langsmith/images/mda-slack-oauth-redirect-urls.png)


  
![Slack message from the MDA app telling an unlinked user to connect their account via a settings URL before using the agent](/langchain/images/langsmith/images/mda-slack-connect-prompt.png)
