...
This page covers the **channel** (conversation ingress/egress). Use the [GitHub connector](lc:langsmith/managed-deep-agents-connectors/github) for sandbox checkouts, or Connect-with-GitHub under [identity](lc:langsmith/managed-deep-agents-identity) for user OAuth.
...
1. Put GitHub App secrets in `.env` and ensure [identity](lc:langsmith/managed-deep-agents-identity) is declared.
