...
![Upload inline multimodal content](/langchain/images/langsmith/images/upload-inline-multimodal-content.png)
...
![Template variable multimodal content](/langchain/images/langsmith/images/template-variable-multimodal-content.png)
...
![Manual prompt multimodal](/langchain/images/langsmith/images/manual-prompt-multimodal.png)

## Run an evaluation

After testing out your prompt manually, you can [run an evaluation](lc:langsmith/evaluate-with-attachments) to see how the prompt performs over a golden dataset of examples.
