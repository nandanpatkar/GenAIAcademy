This page describes the [prompt template](lc:langsmith/prompt-engineering-concepts#prompts-vs-prompt-templates) formats supported in the [Playground](lc:langsmith/prompt-engineering-concepts#playground), [prompt hub](lc:langsmith/manage-prompts#public-prompt-hub), and [evaluators](lc:langsmith/evaluation-concepts#evaluators). Prompt templates allow you to create reusable prompts with dynamic placeholders that get filled in at runtime.


> [!TIP]
>
> For a general overview of prompt engineering and prompt templates, refer to the [Concepts](lc:langsmith/prompt-engineering-concepts#prompts-vs-prompt-templates) page.
...
When building [evaluators](lc:langsmith/evaluation-concepts#evaluators) or working with conversational AI, LangSmith automatically provides special variables that structure conversation data in useful ways. These variables are **only available in evaluator contexts**, not in regular Playground prompts.
...
LangSmith provides three pre-structured views of conversation [threads](lc:langsmith/evaluation-concepts#threads):
...
[Few-shot examples](lc:langsmith/create-few-shot-evaluators#how-few-shot-examples-work) help the LLM understand:
