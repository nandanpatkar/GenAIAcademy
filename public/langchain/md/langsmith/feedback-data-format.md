...
1. [Sent up along with a trace](lc:langsmith/attach-user-feedback) from the LLM application
2. Generated by a user in the app [inline](lc:langsmith/annotate-traces-inline) or in an [annotation queue](lc:langsmith/annotation-queues)
3. Generated by an automatic evaluator during [offline evaluation](lc:langsmith/evaluate-llm-application)
4. Generated by an [online evaluator](lc:langsmith/online-evaluations-llm-as-judge)
