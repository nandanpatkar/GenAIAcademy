...
To add a remote MCP server to all agents in the workspace:
  ...
  #### Tab: From Fleet > Integrations

    
      #### Step: Navigate to Fleet > Integrations
  ...
  #### Tab: From workspace settings

    
      #### Step: Navigate to MCP server settings
