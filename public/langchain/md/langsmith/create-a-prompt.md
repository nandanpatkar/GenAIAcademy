...
![Empty playground](/langchain/images/langsmith/images/empty-playground-light.png)


![Empty playground](/langchain/images/langsmith/images/empty-playground-dark.png)
...
The default [template format](lc:langsmith/prompt-template-format) is f-string, but you can change the prompt template format to mustache by clicking on the dropbox below the prompt boxes.
...
![Variable in prompt box.](/langchain/images/langsmith/images/prompt-with-variable-light.png)


    
![Variable in prompt box.](/langchain/images/langsmith/images/prompt-with-variable-dark.png)
...
![Double clicking on a prompt displays the variable icon.](/langchain/images/langsmith/images/convert-to-variable-light.png)


    
![Double clicking on a prompt displays the variable icon.](/langchain/images/langsmith/images/convert-to-variable-dark.png)
...
> 
For more details on the prompt template formats generally and examples in both syntax, refer to the [Prompt template format](lc:langsmith/prompt-template-format) guide.

### Structured output

Adding an output schema to your prompt will get output in a structured format. Learn more about [structured output](lc:langsmith/prompt-engineering-concepts#structured-output).

### Tools

You can also add a tool by clicking the **+ Tool** button at the bottom of the prompt editor. For more information on how to use tools, refer to [Use tools](lc:langsmith/use-tools).

> 
Use the **[Chat](lc:langsmith/chat)** in the Playground to generate tools, create output schemas, and optimize your prompts with AI assistance.
...
Now that you've created a prompt, you can use it in your application code. See [how to pull a prompt programmatically](lc:langsmith/manage-prompts-programmatically#pull-a-prompt).
