...
|---|---|
| [Claude Code](lc:langsmith/trace-claude-code) | `claude-code` |
| [OpenAI Codex](lc:langsmith/trace-with-codex) | `openai-codex` |
| [Deep Agents](lc:langsmith/trace-deep-agents) | `deepagents-code` |
| [Cursor](lc:langsmith/trace-with-cursor) | `cursor` |
| [Pi](lc:langsmith/trace-with-pi) | `pi` |
| [Opencode](lc:langsmith/trace-with-opencode) | `opencode` |
| [GitHub Copilot](lc:langsmith/trace-with-vscode-copilot) | `copilot` |
...
- [Metadata parameters reference](lc:langsmith/ls-metadata-parameters): `ls_` prefixed fields used in LangSmith runs generally.
- [Add metadata and tags](lc:langsmith/add-metadata-tags): how to attach metadata to traces using the LangSmith SDK.
