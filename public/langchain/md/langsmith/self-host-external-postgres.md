...
Use this section to configure TLS for PostgreSQL connections. For mounting internal/public CAs so LangSmith trusts your PostgreSQL server certificate, see [Configure custom TLS certificates](lc:langsmith/self-host-custom-tls-certificates#mount-internal-cas-for-tls).
