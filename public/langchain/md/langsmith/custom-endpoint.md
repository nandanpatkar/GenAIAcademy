...
![ChatCustomModel in Playground](/langchain/images/langsmith/images/playground-custom-model.png)
...
For more information, see [how to store your model configuration for later use](lc:langsmith/managing-model-configurations).
