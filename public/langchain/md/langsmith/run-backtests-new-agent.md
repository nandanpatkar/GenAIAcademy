...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -U langsmith langchain langchain-anthropic langchainhub emoji"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langsmith langchain langchain-anthropic langchainhub emoji"
 }
]
```
...
You can select the runs to backtest on using the `filter` argument of `list_runs`. The `filter` argument uses the LangSmith [trace query syntax](lc:langsmith/trace-query-syntax) to select runs.
...
![Baseline experiment](/langchain/images/langsmith/images/baseline-experiment.png)
...
![Dataset page](/langchain/images/langsmith/images/dataset-page.png)
...
![Tutorial comparison view](/langchain/images/langsmith/images/tutorial-comparison-view.png)
