...
> [!NOTE]
>
> The JS/TS SDK has an analogous [Vitest/Jest integration](lc:langsmith/vitest-jest).
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -U \"langsmith[pytest]\""
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add \"langsmith[pytest]\""
 }
]
```
...
* creates a [dataset](lc:langsmith/evaluation-concepts#datasets) for each test file. If a dataset for this test file already exists it will be updated
* creates an [experiment](lc:langsmith/evaluation-concepts#experiment) in each created/updated dataset
...
![Dataset](/langchain/images/langsmith/images/simple-pytest-dataset.png)

And what an experiment against that test suite looks like:

![Experiment](/langchain/images/langsmith/images/simple-pytest.png)
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -U pytest-xdist\npytest -n auto tests"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add pytest-xdist\npytest -n auto tests"
 }
]
```
...
![Rich pytest outputs](/langchain/images/langsmith/images/rich-pytest-outputs.png)
