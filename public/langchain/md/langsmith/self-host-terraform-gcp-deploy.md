...
> [!TIP]
>
> For a condensed cheat sheet of `make` targets, required variables, and common constraints, see the [GCP quick reference](lc:langsmith/self-host-terraform-gcp-quick-reference).
...
See the [GCP variables reference](lc:langsmith/self-host-terraform-gcp-variables) for every input variable.
...
- Reference the [GCP variables](lc:langsmith/self-host-terraform-gcp-variables) and the [quick reference](lc:langsmith/self-host-terraform-gcp-quick-reference).
- Review the [GCP architecture](lc:langsmith/self-host-terraform-gcp-architecture) for module structure, traffic flow, and Workload Identity.
- When something breaks, check the [GCP troubleshooting guide](lc:langsmith/self-host-terraform-gcp-troubleshooting).
