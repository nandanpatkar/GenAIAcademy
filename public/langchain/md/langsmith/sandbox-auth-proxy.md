...
> [!WARNING]
>
> You must configure your secrets (e.g., `OPENAI_API_KEY`) in your LangSmith [workspace](lc:langsmith/administration-overview#workspaces) settings before creating a sandbox that references them.
