...
#### Step: Define workflow and activity
...
[
 {
  "label": "Go",
  "lang": "go",
  "code": "// Note: langsmith.NewTracer() uses default sampling\n// For custom sampling, use the TracerProvider directly\ntp := sdktrace.NewTracerProvider(\n    sdktrace.WithBatcher(exporter),\n    sdktrace.WithSampler(sdktrace.TraceIDRatioBased(0.1)), // 10% sampling\n)"
 },
 {
  "label": "Python",
  "lang": "python",
  "code": "from opentelemetry.sdk.trace.sampling import TraceIdRatioBased\n\nprovider = TracerProvider(\n    resource=resource,\n    sampler=TraceIdRatioBased(0.1),  # 10% sampling\n)"
 }
]
```
...
[
 {
  "label": "Go",
  "lang": "go",
  "code": "defer ls.Shutdown(context.Background())"
 },
 {
  "label": "Python",
  "lang": "python",
...
- [Learn about LangSmith tracing concepts](lc:langsmith/observability-concepts)
- [Explore OpenTelemetry semantic conventions](lc:langsmith/trace-with-opentelemetry#supported-opentelemetry-attribute-and-event-mapping)
