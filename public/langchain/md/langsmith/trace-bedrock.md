This guide shows you how to trace [Amazon Bedrock](https://aws.amazon.com/bedrock) model calls with LangSmith using the native AWS SDKs. LangSmith also works seamlessly with [LangChain's Bedrock integrations](lc:oss/python/integrations/providers/aws). Either approach provides insights into:
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install boto3 langsmith"
 },
 {
  "label": "npm",
  "lang": "bash",
  "code": "npm install @aws-sdk/client-bedrock-runtime langsmith"
 }
]
```
...
To enable LangSmith tracing, configure your [LangSmith API key](lc:langsmith/create-account-api-key) and project settings. You'll also need to set up your AWS credentials to authenticate with Bedrock.
...
- Review [LangChain Bedrock integration documentation](lc:oss/python/integrations/chat/bedrock) for advanced features like extended thinking and citations
