...
Each of these dictionaries can contain any or all of the [feedback fields](lc:langsmith/feedback-data-format); check out the linked document for more information.
...
![multiple_scores.png](/langchain/images/langsmith/images/multiple-scores.png)

## Related

* [Return categorical vs numerical metrics](lc:langsmith/metric-type)
