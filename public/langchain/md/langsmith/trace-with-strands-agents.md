...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install \"langsmith[strands-agents]\""
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add \"langsmith[strands-agents]\""
 }
]
```
...
Set your [LangSmith API key](lc:langsmith/create-account-api-key) and project name. If you use Amazon Bedrock as the model provider for Strands Agents, also configure AWS credentials with your preferred AWS authentication method.
...
- [LangSmith OpenTelemetry guide](lc:langsmith/trace-with-opentelemetry)
