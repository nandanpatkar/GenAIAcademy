...
1. Locate the format icon  at the top right of the runs table.
...
![Configure Input and Output previews side panel showing the tree view of trace data structure](/langchain/images/langsmith/images/configure-preview.png)


![Configure Input and Output previews side panel showing the tree view of trace data structure](/langchain/images/langsmith/images/configure-preview-dark.png)
...
- Learn more about [viewing and filtering traces](lc:langsmith/filter-traces-in-application).
- Explore [custom output rendering](lc:langsmith/custom-output-rendering) for advanced visualization.
- Set up [metadata and tags](lc:langsmith/add-metadata-tags) to organize your traces.
