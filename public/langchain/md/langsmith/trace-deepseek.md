...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install openai langsmith"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add openai langsmith"
 },
 {
  "label": "npm",
  "lang": "bash",
  "code": "npm install openai langsmith dotenv"
 }
]
```
...
- Specify a [`LANGSMITH_PROJECT`](lc:langsmith/log-traces-to-project) name to organize traces by project; if not set, traces go to the default project (named "default").
    ...
    [
     {
      "label": "Python",
      "lang": "bash",
      "code": "python deepseek_trace.py"
     },
     {
      "label": "TypeScript",
      "lang": "bash",
      "code": "node deepseek_trace.js"
     }
    ]
    ```
...
To enable automatic cost tracking for LLM calls, refer to [Automatically track costs based on token counts](lc:langsmith/cost-tracking#llm-calls:-automatically-track-costs-based-on-token-counts).
