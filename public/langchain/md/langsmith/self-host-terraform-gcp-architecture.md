...
If you are ready to install, start with the [deployment walkthrough](lc:langsmith/self-host-terraform-gcp-deploy).
...
![LangSmith on GCP deployment stages and service layout](/langchain/images/images/self-hosted-terraform/gcp-architecture.png)
