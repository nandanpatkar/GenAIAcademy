...
[
 {
  "label": "Python SDK",
  "lang": "bash",
  "code": "pip install litellm langsmith openai"
 },
 {
  "label": "Proxy usage",
  "lang": "bash",
  "code": "npm install openai langsmith"
 }
]
```
...
1. Set the following environment variables to enable LangSmith tracing for LiteLLM Python SDK usage:
    ...
    ```
    Create LangSmith [API keys](lc:langsmith/create-account-api-key) in the [LangSmith UI](https://smith.langchain.com).
...
> [!TIP]
>
> For more general examples using `@traceable`, refer to the [Custom instrumentation](lc:langsmith/annotate-code#use-@traceable-/-traceable) page.
...
- [View traces in LangSmith](lc:langsmith/filter-traces-in-application)
- [Add custom metadata](lc:langsmith/ls-metadata-parameters)
- [Filter and sample traces](lc:langsmith/sample-traces)
