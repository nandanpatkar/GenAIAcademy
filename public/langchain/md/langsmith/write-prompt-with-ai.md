...
![Prompt canvas open](/langchain/images/langsmith/images/prompt-canvas-open.gif)
...
![Prompt canvas rewrite](/langchain/images/langsmith/images/prompt-canvas-rewrite.gif.poster.png "heavy:6.7:https://docs.langchain.com/langsmith/images/prompt-canvas-rewrite.gif")
...
![Prompt canvas quick actions](/langchain/images/langsmith/images/prompt-canvas-quick-actions.gif.poster.png "heavy:9.3:https://docs.langchain.com/langsmith/images/prompt-canvas-quick-actions.gif")
...
![Prompt canvas custom quick action](/langchain/images/langsmith/images/prompt-canvas-custom-quick-action.gif.poster.png "heavy:12.4:https://docs.langchain.com/langsmith/images/prompt-canvas-custom-quick-action.gif")
...
![Prompt canvas diff](/langchain/images/langsmith/images/prompt-canvas-diff.gif.poster.png "heavy:8.1:https://docs.langchain.com/langsmith/images/prompt-canvas-diff.gif")
...
![Prompt canvas save](/langchain/images/langsmith/images/prompt-canvas-save.gif.poster.png "heavy:3.2:https://docs.langchain.com/langsmith/images/prompt-canvas-save.gif")
