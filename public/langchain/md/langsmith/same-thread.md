...
You'll see that the second assistant will respond using information from the [checkpoint](lc:oss/python/langgraph/checkpointers#checkpoints) generated in the thread by the first assistant as context.
