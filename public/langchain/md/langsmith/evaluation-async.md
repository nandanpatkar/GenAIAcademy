> [!NOTE]
>
> [Evaluations](lc:langsmith/evaluation-concepts#evaluation-lifecycle) | [Evaluators](lc:langsmith/evaluation-concepts#evaluators) | [Datasets](lc:langsmith/evaluation-concepts#datasets) | [Experiments](lc:langsmith/evaluation-concepts#experiment)


We can run evaluations asynchronously via the SDK using [aevaluate()](https://docs.smith.langchain.com/reference/python/evaluation/langsmith.evaluation._arunner.aevaluate), which accepts all of the same arguments as [evaluate()](https://docs.smith.langchain.com/reference/python/evaluation/langsmith.evaluation._runner.evaluate) but expects the application function to be asynchronous. To learn more, see [how to use the `evaluate()` function](lc:langsmith/evaluate-llm-application).


> [!NOTE]
>
> This guide is only relevant when using the Python SDK. In JS/TS the `evaluate()` function is already async. For more information, see [Evaluate LLM applications](lc:langsmith/evaluate-llm-application).
...
* [Run an evaluation (synchronously)](lc:langsmith/evaluate-llm-application)
* [Handle model rate limits](lc:langsmith/handle-model-rate-limiting)
