...
For a full list of packages available, see the [LangChain docs](lc:oss/python/integrations/providers/overview).
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain_openai"
 },
 {
  "label": "yarn",
  "lang": "bash",
  "code": "yarn add @langchain/openai @langchain/core"
 },
 {
  "label": "npm",
  "lang": "bash",
  "code": "npm install @langchain/openai @langchain/core"
 },
 {
  "label": "pnpm",
  "lang": "bash",
  "code": "pnpm add @langchain/openai @langchain/core"
 }
]
```
...
> [!NOTE]
>
> The `ls_model_name` metadata parameter is also used for [cost tracking](lc:langsmith/cost-tracking). When combined with the `ls_provider` parameter, LangSmith can automatically calculate costs for custom or self-hosted models. For more information about all available metadata parameters, see the [metadata parameters reference](lc:langsmith/ls-metadata-parameters).
...
LangSmith supports distributed tracing with LangChain Python. This allows you to link runs (spans) across different services and applications. The principles are similar to the [distributed tracing guide](lc:langsmith/distributed-tracing) for the LangSmith SDK.
...
If you are using LangChain for part of your application and the LangSmith SDK (see [Custom instrumentation](lc:langsmith/annotate-code)) for other parts, you can still trace the entire application seamlessly.
...
This will produce the following trace tree: ![Trace tree python interop](/langchain/images/langsmith/images/trace-tree-python-interop.png)
...
![Trace Tree](/langchain/images/langsmith/images/trace-tree-manual-tracing.png)
