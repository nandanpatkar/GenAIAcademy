...
> * [`useStream()` React Hook](lc:oss/python/langchain/frontend/overview)
...
![Agent Chat showing a prompt about booking/lodging and a generated set of hotel listing cards (images, titles, prices, locations) rendered inline as UI components.](/langchain/images/langsmith/images/generative-ui-sample.jpg)
