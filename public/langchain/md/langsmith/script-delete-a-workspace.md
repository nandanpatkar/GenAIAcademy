> [!NOTE]
>
> Deleting a workspace is supported **nativley in LangSmith Self-Hosted v0.10**. View [instructions for deleting a workspace](lc:langsmith/set-up-hierarchy#delete-a-workspace).
>
