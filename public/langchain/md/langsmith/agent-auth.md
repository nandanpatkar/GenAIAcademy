> [!NOTE]
>
> Agent Auth is in **[beta](lc:langsmith/release-stages)** and under active development. To provide feedback or use this feature, reach out to the [LangChain team](https://forum.langchain.com/c/help/langsmith/).
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-auth"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-auth"
 }
]
```
...
#### Tab: Explicit Configuration (Python)
...
#### Tab: Explicit Configuration (JavaScript)
...
![](/langchain/images/images/langgraph-auth-interrupt.png)
...
![](/langchain/images/images/github-auth-success.png)
