...
While you can [dynamically fetch prompts](lc:langsmith/manage-prompts-programmatically#pull-a-prompt) from LangSmith into your application at runtime, you may prefer to sync prompts with your own database or version control system. To support this workflow, LangSmith allows you to receive notifications of prompt updates via webhooks.
...
![Prompt Webhook Diagram](/langchain/images/langsmith/images/prompt-excalidraw.png)
...
2. Go to the **Prompts** section. Here you'll see a list of your prompts.
   ...
   ![LangSmith Prompts section](/langchain/images/langsmith/images/prompt-commit-main.png)
...
4. You'll be presented with a form to configure your webhook:
   ...
   ![LangSmith Webhook configuration modal](/langchain/images/langsmith/images/prompt-commit-webhook.png)
...
![Workflow Diagram showing: User saves prompt in LangSmith, LangSmith sends webhook to FastAPI Server, which interacts with GitHub to update files](/langchain/images/langsmith/images/prompt-sequence-diagram.png)
...
6. **Confirmation:** You should see the new commit appear in your GitHub repository.
   ...
   ![Manifest committed to GitHub](/langchain/images/langsmith/images/prompt-commit-github.png)
