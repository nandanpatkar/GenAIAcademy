...
For more information on the evaluation workflows LangSmith supports, check out the [how-to guides](lc:langsmith/evaluation), or see the reference docs for `evaluate`[Client.evaluate] and its asynchronous `aevaluate`[Client.aevaluate] counterpart.
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -U langsmith openai"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langsmith openai"
 }
]
```
...
![Testing tutorial dataset](/langchain/images/langsmith/images/testing-tutorial-dataset.png)
...
![Testing tutorial run](/langchain/images/langsmith/images/testing-tutorial-run.png)

If we go back to the dataset page and select the `Experiments` tab, we can now see a summary of our one run!

![Testing tutorial one run](/langchain/images/langsmith/images/testing-tutorial-one-run.png)
...
![Testing tutorial three runs](/langchain/images/langsmith/images/testing-tutorial-three-runs.png)
...
![Testing tutorial compare metrics](/langchain/images/langsmith/images/testing-tutorial-compare-metrics.png)
...
![Testing tutorial compare runs](/langchain/images/langsmith/images/testing-tutorial-compare-runs.png)
...
![Testing tutorial side panel](/langchain/images/langsmith/images/testing-tutorial-side-panel.png)
...
![Testing tutorial over time](/langchain/images/langsmith/images/testing-tutorial-over-time.png)
...
This is just the start. As mentioned earlier, evaluation is an ongoing process. For example - the datapoints you will want to evaluate on will likely continue to change over time. There are many types of evaluators you may wish to explore. For information on this, check out the [how-to guides](lc:langsmith/evaluation).

Additionally, there are other ways to evaluate data besides in this "offline" manner (e.g. you can evaluate production data). For more information on online evaluation, check out [Set up LLM-as-a-judge online evaluators](lc:langsmith/online-evaluations-llm-as-judge).
