...
For more details on these services, refer to the [self-hosted overview](lc:langsmith/self-hosted).
...
6. Apply helm chart with updated size (You can follow the [upgrade guide](lc:langsmith/self-host-upgrades))
