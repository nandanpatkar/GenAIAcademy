...
[LangChain](lc:oss/python/langchain/overview) is an agent framework that provides abstractions like structured content blocks, the agent loop, and middleware.
...
While LangChain is built on top of [LangGraph](lc:oss/python/langgraph/overview), you don't need to know LangGraph to use LangChain.
...
[LangGraph](lc:oss/python/langgraph/overview) is a low-level orchestration framework and runtime for building, managing, and deploying long-running, stateful agents.
...
The [Deep Agents SDK](lc:oss/python/deepagents/overview) builds on top of LangGraph and adds planning capabilities, file systems for context management, the ability to spawn subagents, and more.
...
Use the [Deep Agents SDK](lc:oss/python/deepagents/overview) when:
...
| ------- | --------- | ----------- | ----------- |
| Short-term memory | [Short-term memory](lc:oss/python/langgraph/add-memory#add-short-term-memory) | [Short-term memory](lc:oss/python/langchain/short-term-memory) | [`StateBackend`](lc:oss/python/deepagents/backends#statebackend) |
| Long-term memory | [Long-term memory](lc:oss/python/langgraph/add-memory#add-long-term-memory) | [Long-term memory](lc:oss/python/langchain/long-term-memory) | [Long-term memory](lc:oss/python/deepagents/memory) |
| Skills  | - | [Multi-agent skills](lc:oss/python/langchain/multi-agent/skills) | [Skills](lc:oss/python/deepagents/skills) |
| Subagents | [Subgraphs](lc:oss/python/langgraph/use-subgraphs) | [Multi-agent subagents](lc:oss/python/langchain/multi-agent/subagents) | [Subagents](lc:oss/python/deepagents/subagents) |
| Human-in-the-loop | [Interrupts](lc:oss/python/langgraph/interrupts) | [Human-in-the-loop middleware](lc:oss/python/langchain/human-in-the-loop) | [`interrupt_on` parameter](https://docs.langchain.com/oss/deepagents/harness#human-in-the-loop) |
| Streaming | [Streaming](lc:oss/python/langgraph/streaming) | [Agent Streaming](lc:oss/python/langchain/event-streaming) | [Streaming](lc:oss/python/deepagents/event-streaming) |

## Learn more

- [LangChain overview](lc:oss/python/langchain/overview)
- [LangGraph overview](lc:oss/python/langgraph/overview)
- [Deep Agents overview](lc:oss/python/deepagents/overview)
