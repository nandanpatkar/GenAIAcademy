...
> [!TIP]
>
> New to context engineering? Start with the [conceptual overview](lc:oss/python/concepts/context) to understand the different types of context and when to use them.
...
LangChain [middleware](lc:oss/python/langchain/middleware/overview) is the mechanism under the hood that makes context engineering practical for developers using LangChain.
...
> - Use life-cycle hooks like `before_model`, `after_model`, or `wrap_tool_call` (for tool returns) to update the conversation history. See the [middleware documentation](lc:oss/python/langchain/middleware/overview) for more details.
>
>
> See [State updates](lc:oss/python/langchain/middleware/custom#state-updates) for more information.
...
See [Dynamic tools](lc:oss/python/langchain/tools#dynamic-tool-selection) for both filtering pre-registered tools and registering tools at runtime (e.g., from MCP servers).
...
See [Dynamic model](lc:oss/python/langchain/models#dynamic-model-selection) for more examples.
...
See [Tools](lc:oss/python/langchain/tools) for comprehensive examples of accessing state, store, and runtime context in tools.
...
As you've seen in [Model Context](#model-context) and [Tool Context](#tool-context), [middleware](lc:oss/python/langchain/middleware/overview) is the mechanism that makes context engineering practical. Middleware allows you to hook into any step in the agent lifecycle and either:
...
![Middleware hooks in the agent loop](/langchain/images/oss/images/middleware_final.png)
...
> [!NOTE]
>
> For a complete list of built-in middleware, available hooks, and how to create custom middleware, see the [Middleware documentation](lc:oss/python/langchain/middleware/overview).
...
4. **Use built-in middleware** - Leverage [`SummarizationMiddleware`](lc:oss/python/langchain/middleware/overview#summarization), [`LLMToolSelectorMiddleware`](lc:oss/python/langchain/middleware/overview#llm-tool-selector), etc.
...
- [Context conceptual overview](lc:oss/python/concepts/context) - Understand context types and when to use them
- [Middleware](lc:oss/python/langchain/middleware/overview) - Complete middleware guide
- [Tools](lc:oss/python/langchain/tools) - Tool creation and context access
- [Memory](lc:oss/python/concepts/memory) - Short-term and long-term memory patterns
- [Agents](lc:oss/python/langchain/agents) - Core agent concepts
