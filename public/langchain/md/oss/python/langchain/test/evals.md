...
LangSmith offers two main approaches for running evaluations: [pytest](lc:langsmith/pytest) integration and the `evaluate` function.
...
Create a [LangSmith dataset](lc:langsmith/manage-datasets) and use the `evaluate` function. The dataset must have the following schema:
...
> [!TIP]
>
> To learn more about evaluating your agent, see the [LangSmith docs](lc:langsmith/pytest).
