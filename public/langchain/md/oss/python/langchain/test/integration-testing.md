...
> [!TIP]
>
> For more rigorous trajectory assertions, use the [AgentEvals](lc:oss/python/langchain/test/evals) evaluators which support fuzzy matching modes like `unordered` and `superset`.
...
Learn how to evaluate agent trajectories with deterministic matching or LLM-as-judge evaluators in [Evals](lc:oss/python/langchain/test/evals).
