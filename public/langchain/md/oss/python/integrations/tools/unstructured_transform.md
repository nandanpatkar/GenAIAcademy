...
[tools](lc:oss/python/langchain/tools). The [Unstructured Transform](https://docs.unstructured.io/transform/overview)
...
It's also helpful (but not needed) to set up LangSmith for best-in-class observability/tracing of your tool calls. To enable automated tracing, set your [LangSmith](lc:langsmith/observability) API key:
    ...
    [
     {
      "label": "pip",
      "lang": "python",
      "code": "pip install -U langchain-unstructured-transform"
     },
     {
      "label": "uv",
      "lang": "python",
      "code": "uv add langchain-unstructured-transform"
     }
    ]
    ```
