...
| :--- | :--- | :---: | :---: | :---: |
| `ParallelMonitor` | `langchain-parallel` | ❌ | ❌ | <a href="https://pypi.org/project/langchain-parallel/" target="_blank">
...
For detailed documentation, head to the `ParallelMonitor` API reference or the [Monitor API guides](https://docs.parallel.ai/monitor-api/monitor-quickstart).
