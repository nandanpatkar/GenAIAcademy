...
| [Returns artifact](lc:oss/python/langchain/tools) | Native async | Supports browser interaction | Pricing |
|:-----------------------------------------------:|:------------:|:----------------------------:|:-------:|
| ✅ | ✅ | ✅ | Pay-per-use (AWS) |
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install -U langchain-aws bedrock-agentcore playwright beautifulsoup4\nplaywright install chromium"
     },
     {
      "label": "uv",
      "lang": "bash",
