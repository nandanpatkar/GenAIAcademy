...
| :--- | :--- | :---: | :---: | :---: |
| `ParallelExtractTool` | `langchain-parallel` | ❌ | ❌ | <a href="https://pypi.org/project/langchain-parallel/" target="_blank">
...
For detailed documentation, head to the `ParallelExtractTool` API reference or the [Parallel Extract reference](https://docs.parallel.ai/api-reference/extract/extract).
