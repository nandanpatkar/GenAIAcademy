...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install \"langsmith[sandbox]\" deepagents"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add \"langsmith[sandbox]\" deepagents"
 }
]
```
...
Create a LangSmith sandbox with `SandboxClient`, then wrap it in `LangSmithSandbox` to run it as a [Deep Agents backend](lc:oss/python/deepagents/backends).
...
- [Sandboxes in Deep Agents](lc:oss/python/deepagents/sandboxes): lifecycle, scoping, and a comparison of sandbox providers.
- [LangSmith Sandboxes](lc:langsmith/sandboxes): snapshots, service URLs, the auth proxy, and the SDK reference.
