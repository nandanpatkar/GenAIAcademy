...
If you want to get best in-class automated tracing of your model calls you can also set your [LangSmith](lc:langsmith/observability) API key by uncommenting below:
...
For a full list of the different searches you can execute on a `PGVector` vector store, please refer to the `API reference`[PGVector].
