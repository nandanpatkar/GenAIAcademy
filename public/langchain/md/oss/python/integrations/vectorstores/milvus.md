...
For a full list of all the search options available when using the `Milvus` vector store, you can visit the `API reference`[MilvusVectorStore].
...
For detailed documentation of all `Milvus` VectorStore features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-milvus/vectorstores/milvus/Milvus).
