    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-huggingface"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-huggingface"
     }
    ]
    ```
 */}
...
See a [usage example](lc:oss/python/integrations/chat/huggingface).
...
See a [usage example](lc:oss/python/integrations/llms/huggingface_endpoint).
...
See a [usage example](lc:oss/python/integrations/llms/huggingface_pipelines).
...
See a [usage example](lc:oss/python/integrations/embeddings/huggingfacehub).
...
BGE models are Sentence Transformers models, so use `HuggingFaceEmbeddings` with `encode_kwargs={"normalize_embeddings": True}`. See a [usage example](lc:oss/python/integrations/embeddings/bge_huggingface).
