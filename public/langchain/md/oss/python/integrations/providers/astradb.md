...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install \"langchain-astradb>=0.6,<0.7\""
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-astradb>=0.6,<0.7"
 }
]
```
...
Learn more in the [example notebook](lc:oss/python/integrations/vectorstores/astradb).
...
Learn more in the [example notebook](lc:oss/python/integrations/document_loaders/astradb).
