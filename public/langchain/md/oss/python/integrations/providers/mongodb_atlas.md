...
See [detail configuration instructions](lc:oss/python/integrations/vectorstores/mongodb_atlas).
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-mongodb"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-mongodb"
 }
]
```
...
See a [usage example](lc:oss/python/integrations/vectorstores/mongodb_atlas).
...
The MongoDBAtlasSemanticCache inherits from `MongoDBAtlasVectorSearch` and needs an Atlas Vector Search Index defined to work. Please look at the [usage example](lc:oss/python/integrations/vectorstores/mongodb_atlas) on how to set up the index.
