...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-weaviate"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-weaviate"
 }
]
```
...
For a more detailed walkthrough of the Weaviate wrapper, see [this notebook](lc:oss/python/integrations/vectorstores/weaviate)
