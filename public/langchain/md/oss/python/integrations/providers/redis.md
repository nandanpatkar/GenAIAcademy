...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install redis langchain-redis"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add redis langchain-redis"
 }
]
```
...
For a detailed walkthrough, see the [Redis vector store integration guide](lc:oss/python/integrations/vectorstores/redis).
