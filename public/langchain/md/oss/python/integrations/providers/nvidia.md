...
See the [`ChatNVIDIA` integration page](lc:oss/python/integrations/chat/nvidia_ai_endpoints) for full documentation including tool calling, multimodal inputs, and Nemotron-specific examples.
...
See the [`ChatNVIDIA` integration page](lc:oss/python/integrations/chat/nvidia_ai_endpoints#use-with-nvidia-dynamo) for the full `ChatNVIDIADynamo` reference including per-invocation overrides and streaming.
...
See the [`NVIDIAEmbeddings` integration page](lc:oss/python/integrations/embeddings/nvidia_ai_endpoints) for full documentation.
...
See the [`NVIDIARAGRetriever` integration page](lc:oss/python/integrations/retrievers/nvidia) for full documentation.
...
- [`ChatNVIDIA` Model](lc:oss/python/integrations/chat/nvidia_ai_endpoints)
- [`NVIDIAEmbeddings` Model for RAG Workflows](lc:oss/python/integrations/embeddings/nvidia_ai_endpoints)
- [`NVIDIARAGRetriever`](lc:oss/python/integrations/retrievers/nvidia)
