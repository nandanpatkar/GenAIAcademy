...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-tavily"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-tavily"
 }
]
```
...
See a [usage example](lc:oss/python/integrations/tools/tavily_search).
...
See a [usage example](lc:oss/python/integrations/tools/tavily_extract).
...
See a [usage example](lc:oss/python/integrations/tools/tavily_crawl).
...
See a [usage example](lc:oss/python/integrations/tools/tavily_map).
...
|-------|-------------|-------------|-------------|
| `TavilySearch` | Tool | `from langchain_tavily import TavilySearch` | Returns search results from the Tavily Search API. |
| `TavilyExtract` | Tool | `from langchain_tavily import TavilyExtract` | Extracts cleaned content from one or more URLs. |
| `TavilyCrawl` | Tool | `from langchain_tavily import TavilyCrawl` | Crawls a site starting from a base URL with depth and breadth controls. |
| `TavilyMap` | Tool | `from langchain_tavily import TavilyMap` | Discovers the URL structure of a site without extracting page content. |
