...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-oci oci"
 },
 {
  "label": "uv",
  "lang": "bash",
...
See [usage example](lc:oss/python/integrations/chat/oci_generative_ai).
...
See [usage example](lc:oss/python/integrations/embeddings/oci_generative_ai).
...
See the [ChatOCIModelDeployment integration guide](lc:oss/python/integrations/chat/oci_data_science).
