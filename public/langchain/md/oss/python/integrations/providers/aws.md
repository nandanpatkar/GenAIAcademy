    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-aws"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-aws"
     }
    ]
    ```
...
See a [usage example](lc:oss/python/integrations/chat/bedrock).
...
See a [usage example](lc:oss/python/integrations/llms/bedrock).
...
See a [usage example](lc:oss/python/integrations/llms/sagemaker).
...
See a [usage example](lc:oss/python/integrations/embeddings/bedrock).
```python
...
```
See a [usage example](lc:oss/python/integrations/vectorstores/memorydb).
...
See a [usage example](lc:oss/python/integrations/vectorstores/valkey).
...
See a [usage example](lc:oss/python/integrations/retrievers/bedrock).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-aws bedrock-agentcore playwright beautifulsoup4"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-aws bedrock-agentcore playwright beautifulsoup4"
     }
    ]
    ```

See a [usage example](lc:oss/python/integrations/tools/bedrock_agentcore_browser).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-aws bedrock-agentcore"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-aws bedrock-agentcore"
     }
    ]
    ```

See a [usage example](lc:oss/python/integrations/tools/bedrock_agentcore_code_interpreter).
...
### [AgentCoreSandbox](lc:oss/python/integrations/sandboxes/aws)
...
See a [usage example](lc:oss/python/integrations/graphs/amazon_neptune_open_cypher).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langgraph-checkpoint-aws"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langgraph-checkpoint-aws"
     }
    ]
    ```
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install boto3 nltk"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add boto3 nltk"
     }
    ]
    ```
