...
[
 ...
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add databricks-langchain"
 }
]
```
...
See the [usage example](lc:oss/python/integrations/chat/databricks) for more guidance on how to use it within your LangChain application.
...
See the [usage example](lc:oss/python/integrations/embeddings/databricks) for more guidance on how to use it within your LangChain application.
...
See the [usage example](lc:oss/python/integrations/vectorstores/databricks_vector_search) for how to set up vector indices and integrate them with LangChain.
...
See [MLflow LangChain Integration](lc:oss/python/integrations/providers/mlflow_tracking) to learn about the full capabilities of using MLflow with LangChain through extensive code examples and guides.
...
To directly integrate Databricks's open models hosted on HuggingFace, you can use the [HuggingFace Integration](lc:oss/python/integrations/providers/huggingface) of LangChain.
