...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-discord-shikenso"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-discord-shikenso"
 }
]
```
...
Below is a snippet showing how you can read and send messages in Discord. For more details, see the [documentation for Discord tools](lc:oss/python/integrations/tools/discord).
...
`DiscordToolkit` groups multiple Discord-related tools into a single interface. For a usage example, see [the Discord toolkit docs](lc:oss/python/integrations/tools/discord).
