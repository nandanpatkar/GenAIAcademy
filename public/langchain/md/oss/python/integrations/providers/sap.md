...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-hana"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-hana"
 }
]
```
...
See a [usage example](lc:oss/python/integrations/vectorstores/sap_hanavector).
...
See a [usage example](lc:oss/python/integrations/graphs/sap_hana_rdf_graph).
...
See a [usage example](lc:oss/python/integrations/chains/sap_hana_sparql_qa_chain).
