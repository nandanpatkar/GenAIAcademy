...
> **Claude on Azure**
>
>     Microsoft Foundry also offers access to all [Anthropic Claude models](https://learn.microsoft.com/en-us/azure/foundry/foundry-models/how-to/use-foundry-models-claude), including Opus, Sonnet, and Haiku. Claude models are served through a dedicated Anthropic-native endpoint rather than the Azure OpenAI v1 API. Use [`langchain-anthropic`](lc:oss/python/integrations/chat/anthropic) pointed at your Foundry Anthropic endpoint.
...
See the [Azure ChatOpenAI integration page](lc:oss/python/integrations/chat/azure_chat_openai) for end-to-end setup, Entra ID authentication, tool calling, and reasoning examples.
...
For a walkthrough of reasoning effort, reasoning summaries, and streaming with the Responses API, see the [Azure ChatOpenAI integration page](lc:oss/python/integrations/chat/azure_chat_openai).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install -U langchain-azure-ai"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-azure-ai"
     }
    ]
    ```

See a [usage example](lc:oss/python/integrations/chat/azure_ai).
...
See a [usage example](lc:oss/python/integrations/llms/azure_openai).
...
See a [usage example](lc:oss/python/integrations/embeddings/azure_openai).
...
See a [usage example](lc:oss/python/integrations/providers/azure_ai#azure-ai-model-inference-for-embeddings).
...
See the [Microsoft Foundry middleware guide](lc:oss/python/integrations/middleware/azure_ai).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-azure-storage"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-azure-storage"
     }
    ]
    ```

See [usage examples for the Azure Blob Storage Loader](lc:oss/python/integrations/document_loaders/azure_blob_storage).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-azure-cosmosdb"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-azure-cosmosdb"
     }
    ]
    ```
...
See [detailed configuration instructions](lc:oss/python/integrations/vectorstores/azure_cosmos_db_mongo_vcore).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-azure-ai pymongo"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-azure-ai pymongo"
     }
    ]
    ```
...
See a [usage example](lc:oss/python/integrations/vectorstores/azure_cosmos_db_mongo_vcore).
...
See [detail configuration instructions](lc:oss/python/integrations/vectorstores/azure_cosmos_db_no_sql).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-azure-cosmosdb azure-cosmos"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-azure-cosmosdb azure-cosmos"
     }
    ]
    ```
...
See a [usage example](lc:oss/python/integrations/vectorstores/azure_cosmos_db_no_sql).
...
Since Azure Database for PostgreSQL is open-source Postgres, you can use the [LangChain's Postgres support](lc:oss/python/integrations/vectorstores/pgvector) to connect to Azure Database for PostgreSQL.
...
You need to [enable pgvector extension](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/how-to-use-pgvector) in your database to use Postgres as a vector store. Once you have the extension enabled, you can use the [PGVector in LangChain](lc:oss/python/integrations/vectorstores/pgvector) to connect to Azure Database for PostgreSQL.

See a [usage example](lc:oss/python/integrations/vectorstores/pgvector). Simply use the [connection string](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-python?tabs=cmd%2Cpassword#add-authentication-code) from your Azure Portal.
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install -U \"langchain-azure-ai[tools]\""
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add \"langchain-azure-ai[tools]\""
     }
    ]
    ```

See the [Microsoft Foundry Tools guide](lc:oss/python/integrations/tools/azure_ai_services).
...
See the [Microsoft Foundry tools guide](lc:oss/python/integrations/tools/azure_ai).
...
See the [Azure dynamic sessions setup instructions](lc:oss/python/integrations/tools/azure_dynamic_sessions#setup).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install langchain-azure-dynamic-sessions"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-azure-dynamic-sessions"
     }
    ]
    ```

See a [usage example](lc:oss/python/integrations/tools/azure_dynamic_sessions).
...
See the [Azure Logic Apps integration guide](lc:oss/python/integrations/tools/azure_logic_apps).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install -U \"langchain-azure-ai[tools]\" langchain-mcp-adapters httpx"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add \"langchain-azure-ai[tools]\" langchain-mcp-adapters httpx"
     }
    ]
    ```

See the [Azure AI Foundry Toolbox guide](lc:oss/python/integrations/tools/azure_ai#azureaiprojecttoolbox).
...
See a [usage example](lc:oss/python/integrations/tools/azure_ai_services).
...
- Image Analysis: [AzureAIImageAnalysisTool](lc:oss/python/integrations/tools/azure_ai_services#azureaiimageanalysistool)
- Document Intelligence: [AzureAIDocumentIntelligenceTool](lc:oss/python/integrations/tools/azure_ai_services#azureaidocumentintelligencetool)
- Speech to Text: [AzureAISpeechToTextTool](lc:oss/python/integrations/tools/azure_ai_services#azureaispeechtotexttool)
- Text to Speech: [AzureAITextToSpeechTool](lc:oss/python/integrations/tools/azure_ai_services#azureaitexttospeechtool)
- Text Analytics for Health: [AzureAITextAnalyticsHealthTool](lc:oss/python/integrations/tools/azure_ai_services#azureaitextanalyticshealthtool)
