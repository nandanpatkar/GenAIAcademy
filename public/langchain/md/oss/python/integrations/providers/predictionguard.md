...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-predictionguard"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-predictionguard"
 }
]
```
...
|Completions|Generate Text|[Completions](https://docs.predictionguard.com/api-reference/api-reference/completions)| `from langchain_predictionguard import PredictionGuard` | [PredictionGuard.ipynb](lc:oss/python/integrations/llms/predictionguard)                     |
...
See a [usage example](lc:oss/python/integrations/llms/predictionguard)
