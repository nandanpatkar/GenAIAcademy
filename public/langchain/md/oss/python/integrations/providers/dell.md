...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install powerscale-rag-connector"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add powerscale-rag-connector"
 }
]
```
...
For more information, see [available PowerScale loaders](lc:oss/python/integrations/document_loaders/powerscale).
