...
You can use the [`ExaSearchRetriever`](lc:oss/python/integrations/tools/exa_search#using-exasearchretriever) in a standard retrieval pipeline. You can import it as follows.

See a [usage example](lc:oss/python/integrations/tools/exa_search).
...
You can use Exa as an agent tool as described in the [Exa tool calling docs](lc:oss/python/integrations/tools/exa_search#use-within-an-agent).
