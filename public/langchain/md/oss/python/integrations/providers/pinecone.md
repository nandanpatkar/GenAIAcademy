...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install langchain-pinecone"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-pinecone"
 }
]
```
...
For a more detailed walkthrough of the Pinecone vectorstore, see [this notebook](lc:oss/python/integrations/vectorstores/pinecone)
...
For a more detailed walkthrough, see the [Pinecone Sparse Vector Store notebook](lc:oss/python/integrations/vectorstores/pinecone_sparse).
...
For more detailed usage, see the [Pinecone Sparse Embeddings notebook](lc:oss/python/integrations/vectorstores/pinecone_sparse).
