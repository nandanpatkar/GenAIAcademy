...
- Depending on the region of your provisioned service instance, use one of the URLs described in the [Watsonx Python SDK cloud setup guide](https://ibm.github.io/watsonx-ai-python-sdk/setup_cloud.html#authentication).
