> [!WARNING]
>
> **You are currently on a page documenting the use of OpenAI text completion models. The latest and most popular OpenAI models are [chat completion models](lc:oss/python/langchain/models).**
>
> Unless you are specifically using `gpt-3.5-turbo-instruct`, you are probably looking for [this page instead](lc:oss/python/integrations/chat/openai).
