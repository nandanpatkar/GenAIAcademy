...
| [Image input](lc:oss/python/langchain/messages#multimodal) | Audio input | Video input | [Token-level streaming](lc:oss/python/langchain/streaming) | Native async | [Token usage](lc:oss/python/langchain/models#token-usage) | [Logprobs](lc:oss/python/langchain/models#log-probabilities) |
| :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ |
...
See [LLM](lc:oss/python/langchain/models) for full functionality.
