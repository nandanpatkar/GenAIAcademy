> [!WARNING]
>
> **You are currently on a page documenting the use of Together AI models as text completion models. Many popular Together AI models are [chat completion models](lc:oss/python/langchain/models).**
>
> You may be looking for [this page instead](lc:oss/python/integrations/chat/together).
