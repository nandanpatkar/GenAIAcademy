...
This notebook goes over how to use [Bigtable](https://cloud.google.com/bigtable) to [save, load and delete langchain documents](lc:oss/python/integrations/document_loaders/index) with `BigtableLoader` and `BigtableSaver`.
