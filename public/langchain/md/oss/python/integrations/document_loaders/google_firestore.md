...
This notebook goes over how to use [Firestore](https://cloud.google.com/firestore) to [save, load and delete langchain documents](lc:oss/python/integrations/document_loaders/index) with `FirestoreLoader` and `FirestoreSaver`.
