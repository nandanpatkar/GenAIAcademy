...
This notebook goes over how to use [Cloud SQL for MySQL](https://cloud.google.com/sql/mysql) to [save, load and delete langchain documents](lc:oss/python/integrations/document_loaders/index) with `MySQLLoader` and `MySQLDocumentSaver`.
...
For more information on IAM database authentication please see:
