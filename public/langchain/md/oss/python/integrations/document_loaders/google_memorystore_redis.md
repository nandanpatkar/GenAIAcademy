...
This notebook goes over how to use [Memorystore for Redis](https://cloud.google.com/memorystore/docs/redis/memorystore-for-redis-overview) to [save, load and delete langchain documents](lc:oss/python/integrations/document_loaders/index) with `MemorystoreDocumentLoader` and `MemorystoreDocumentSaver`.
