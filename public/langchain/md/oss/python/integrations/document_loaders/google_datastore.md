...
This notebook goes over how to use [Firestore in Datastore Mode](https://cloud.google.com/datastore) to [save, load and delete langchain documents](lc:oss/python/integrations/document_loaders/index) with `DatastoreLoader` and `DatastoreSaver`.
