...
Initialize the `WatsonxEmbeddings`. For more details see [WatsonxEmbeddings](lc:oss/python/integrations/embeddings/ibm_watsonx).
...
Initialize the `ChatWatsonx`. For more details see [ChatWatsonx](lc:oss/python/integrations/chat/ibm_watsonx).
