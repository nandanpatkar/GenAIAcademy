...
[retriever](lc:oss/python/deepagents/retrieval) that combines **unstructured** similarity search
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -qU langchain-graph-retriever"
 },
 {
  "label": "uv",
  "lang": "bash",
...
[Adapters and Supported Stores](https://datastax.github.io/graph-rag/guide/adapters/).
    ...
    #### Tab: AstraDB
      ...
      consult the [AstraDB Vector Store Guide](lc:oss/python/integrations/vectorstores/astradb).
    ...
    #### Tab: Chroma
      ...
      For help creating a Chroma connection, consult the [Chroma Vector Store Guide](lc:oss/python/integrations/vectorstores/chroma).
