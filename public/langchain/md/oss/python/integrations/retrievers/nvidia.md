...
- [`ChatNVIDIA` integration](lc:oss/python/integrations/chat/nvidia_ai_endpoints)
- [`NVIDIAEmbeddings` integration](lc:oss/python/integrations/embeddings/nvidia_ai_endpoints)
