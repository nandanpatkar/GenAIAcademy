...
> [!NOTE]
>
> Useful when you want to split HTML documents into larger sections, such as `<section>`, ``, or custom-defined sections.
...
[HTMLHeaderTextSplitter](https://reference.langchain.com/python/langchain-text-splitters/html/HTMLHeaderTextSplitter) is a "structure-aware" [text splitter](lc:oss/python/integrations/splitters/index) that splits text at the HTML element level and adds metadata for each header "relevant" to any given chunk. It can return chunks element by element or combine elements with the same metadata, with the objectives of (a) keeping related text grouped (more or less) semantically and (b) preserving context-rich information encoded in document structures. It can be used with other text splitters as part of a chunking pipeline.

It is analogous to the [MarkdownHeaderTextSplitter](lc:oss/python/integrations/splitters/markdown_header_metadata_splitter) for markdown files.
...
Similar in concept to the [HTMLHeaderTextSplitter](#using-htmlheadertextsplitter), the `HTMLSectionSplitter` is a "structure-aware" [text splitter](lc:oss/python/integrations/splitters/index) that splits text at the element level and adds metadata for each header "relevant" to any given chunk. It lets you split HTML by sections.
...
[Document(metadata={'Header 1': 'Main Title'}, page_content='Main Title'),
 ...
 Document(metadata={'Header 2': 'Section 3: Code Example'}, page_content=''),
 Document(metadata={'Header 2': 'Conclusion'}, page_content='Conclusion'),
...
[Document(metadata={'Header 1': 'Main Title'}, page_content='This is an introductory paragraph with some basic content.'),
 ...
 Document(metadata={'Header 2': 'Section 2: Media Content'}, page_content='This section contains an image and a video:  '),
 Document(metadata={'Header 2': 'Section 3: Code Example'}, page_content='This section contains a code block: <code:html>  <p>This is a paragraph inside a div.</p>  </code>'),
 Document(metadata={'Header 2': 'Conclusion'}, page_content='This is the conclusion of the document.')]
```
