    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install -U langchain-text-splitters"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-text-splitters"
     }
    ]
    ```
...
- The [`RecursiveCharacterTextSplitter`](https://docs.langchain.com/oss/integrations/splitters/recursive_text_splitter) attempts to keep larger units (e.g., paragraphs) intact.
...
- [Recursively split text](https://docs.langchain.com/oss/integrations/splitters/recursive_text_splitter)
...
**Available text splitters**:
- [Split by tokens](https://docs.langchain.com/oss/integrations/splitters/split_by_token)
- [Split by characters](https://docs.langchain.com/oss/integrations/splitters/character_text_splitter)
...
**Available text splitters**:
- [Split Markdown](lc:oss/python/integrations/splitters/markdown_header_metadata_splitter)
- [Split JSON](lc:oss/python/integrations/splitters/recursive_json_splitter)
- [Split code](https://docs.langchain.com/oss/integrations/splitters/code_splitter)
- [Split HTML](lc:oss/python/integrations/splitters/split_html)
