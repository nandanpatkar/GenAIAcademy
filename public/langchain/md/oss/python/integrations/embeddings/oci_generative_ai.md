This doc will help you get started with OCI Generative AI [embedding models](lc:oss/python/integrations/embeddings/index). Oracle Cloud Infrastructure (OCI) Generative AI provides state-of-the-art embedding models for text and images, enabling semantic search, RAG, clustering, and cross-modal applications.
...
- [`ChatOCIGenAI`](lc:oss/python/integrations/chat/oci_generative_ai)
- [Embeddings Guide](lc:oss/python/integrations/embeddings/index)
- [RAG Tutorial](lc:oss/python/deepagents/rag)
