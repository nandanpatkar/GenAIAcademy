Middleware specifically designed for Microsoft Foundry and Azure AI Content Safety. Learn more about [middleware](lc:oss/python/langchain/middleware/overview).
...
Pass middleware to `create_agent` in order. You can combine Azure AI middleware with [built-in middleware](lc:oss/python/langchain/middleware/built-in).
