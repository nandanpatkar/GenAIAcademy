...
The package also ships `LiteLLMEmbeddings`, `LiteLLMEmbeddingsRouter`, and `LiteLLMOCRLoader`. See the [providers page](lc:oss/python/integrations/providers/litellm) for details.
...
| [Tool calling](lc:oss/python/langchain/tools) | [Structured output](lc:oss/python/langchain/structured-output) | Image input | Audio input | Video input | [Token-level streaming](lc:oss/python/integrations/chat/litellm#async-and-streaming-functionality) | [Native async](lc:oss/python/integrations/chat/litellm#async-and-streaming-functionality) | [Token usage](lc:oss/python/langchain/models#token-usage) | [Logprobs](lc:oss/python/langchain/models#log-probabilities) |
| :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ |
