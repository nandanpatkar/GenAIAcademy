This page will help you get started with Crusoe AI [chat models](lc:oss/python/langchain/models). For detailed documentation of all ChatCrusoe features and configurations, head to the [Crusoe managed inference docs](https://docs.crusoecloud.com/managed-inference/overview).
    ...
    [
     {
      "label": "pip",
      "lang": "bash",
      "code": "pip install -qU langchain-crusoe"
     },
     {
      "label": "uv",
      "lang": "bash",
      "code": "uv add langchain-crusoe"
     }
    ]
    ```
...
We can [chain](lc:oss/python/langchain/overview) our model with a prompt template like so:
