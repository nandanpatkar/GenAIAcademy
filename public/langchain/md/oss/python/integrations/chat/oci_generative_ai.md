This doc will help you get started with Oracle Cloud Infrastructure (OCI) Generative AI [chat models](lc:oss/python/langchain/models). OCI Generative AI is a fully managed service providing state-of-the-art, customizable large language models covering a wide range of use cases through a single API. Access ready-to-use pretrained models or create and host fine-tuned custom models on dedicated AI clusters.
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -qU langchain-oci oci"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-oci oci"
 }
]
```
...
- [OCI Provider Overview](lc:oss/python/integrations/providers/oci)
- [OCI Embeddings](lc:oss/python/integrations/embeddings/oci_generative_ai)
- [Tool Calling Guide](lc:oss/python/langchain/tools)
- [Structured Output Guide](lc:oss/python/langchain/structured-output)
- [Multimodal Messages](lc:oss/python/langchain/messages#multimodal)
