This will help you get started with NVIDIA [chat models](lc:oss/python/langchain/models). For detailed documentation of all `ChatNVIDIA` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-nvidia-ai-endpoints/chat_models/ChatNVIDIA).
...
For more information on accessing embedding models through this API, refer to the [`NVIDIAEmbeddings`](lc:oss/python/integrations/embeddings/nvidia_ai_endpoints) documentation.
...
See [How to use chat models to call tools](lc:oss/python/langchain/tools) for additional examples.
...
- [`NVIDIAEmbeddings` Model for RAG Workflows](lc:oss/python/integrations/embeddings/nvidia_ai_endpoints)
- [NVIDIA Provider Page](lc:oss/python/integrations/providers/nvidia)
- [Sandboxed agents with NVIDIA OpenShell](lc:oss/python/integrations/providers/nvidia#sandboxed-agents-with-openshell)
- [Post-training agent workflows](lc:oss/python/integrations/providers/nvidia#post-training-agent-workflows)
