...
Head to the [API reference](https://reference.langchain.com/python/langchain-cohere/chat_models/ChatCohere) for detailed documentation of all attributes and methods.
...
ChatCohere supports all [ChatModel](lc:oss/python/langchain/models) functionality:
