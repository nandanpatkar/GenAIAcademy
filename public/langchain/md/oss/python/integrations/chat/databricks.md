...
This guide provides a quick overview for getting started with Databricks [chat models](lc:oss/python/langchain/models).
...
See [Databricks Unity Catalog](lc:oss/python/integrations/tools/databricks) about how to use UC functions in chains.
