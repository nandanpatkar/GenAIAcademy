This will help you get started with OCIModelDeployment [chat models](lc:oss/python/langchain/models). For detailed documentation of all `ChatOCIModelDeployment` features and configurations, see the [langchain-oci package](https://github.com/oracle/langchain-oracle/tree/main/libs/oci).
...
To use `ChatOCIModelDeployment`, deploy a chat model with a chat completion endpoint and install the `langchain-oci` and `oracle-ads` packages.
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install -qU langchain-oci oracle-ads"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add langchain-oci oracle-ads"
 }
]
```
...
For comprehensive details on all features and configurations, see the [langchain-oci package](https://github.com/oracle/langchain-oracle/tree/main/libs/oci) documentation for each class:
