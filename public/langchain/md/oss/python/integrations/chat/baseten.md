This guide provides a quick overview for getting started with `ChatBaseten` [chat models](lc:oss/python/langchain/models).
    ...
    [
     {
      "label": "pip",
      "lang": "python",
      "code": "pip install -U langchain-baseten"
     },
     {
      "label": "uv",
      "lang": "python",
      "code": "uv add langchain-baseten"
     }
    ]
    ```
...
> [!TIP]
>
> Full guides are available on [chat model invocation types](lc:oss/python/langchain/models#invocation), [message types](lc:oss/python/langchain/messages#message-types), and [content blocks](lc:oss/python/langchain/messages#standard-content-blocks).
