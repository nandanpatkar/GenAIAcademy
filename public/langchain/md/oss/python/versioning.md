...
For detailed information about release status and support timelines, see the [Release policy](lc:oss/python/release-policy).
...
[
 {
  "label": "LangChain",
  "lang": "python",
  "code": "print(langchain_core.__version__)"
 },
 {
  "label": "LangGraph",
  "lang": "python",
  "code": "print(langgraph.__version__)"
 }
]
```
...
- [Release policy](lc:oss/python/release-policy) - Detailed release and deprecation policies
