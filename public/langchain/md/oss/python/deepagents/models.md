...
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| google_genai:gemini-3.6-flash | [82%](https://github.com/langchain-ai/deepagents/actions/runs/25455998535) | **[100%](https://github.com/langchain-ai/deepagents/actions/runs/25455998535)** | **[100%](https://github.com/langchain-ai/deepagents/actions/runs/25455998535)** | **[90%](https://github.com/langchain-ai/deepagents/actions/runs/25455998535)** | [54%](https://github.com/langchain-ai/deepagents/actions/runs/25290479270) | [38%](https://github.com/langchain-ai/deepagents/actions/runs/25455998535) | [80%](https://github.com/langchain-ai/deepagents/actions/runs/25455998535) |
...
| Provider | Models |
|----------|--------|
| [Google](lc:oss/python/integrations/providers/google) | `gemini-3.1-pro-preview`, `gemini-3.6-flash` |
| [OpenAI](lc:oss/python/integrations/providers/openai) | `gpt-5.5`, `gpt-5.4` |
| [Anthropic](lc:oss/python/integrations/providers/anthropic) | `claude-opus-4-8`, `claude-opus-4-7`, `claude-opus-4-6` |
| Open-weight | `GLM-5.2`, `Kimi-K2.7 Code`, `MiniMax-M3` |

Open-weight models are available through providers like [Baseten](lc:oss/python/integrations/providers/baseten), [Fireworks](lc:oss/python/integrations/chat/fireworks), [OpenRouter](lc:oss/python/integrations/providers/openrouter), and [Ollama](lc:oss/python/integrations/providers/ollama).
...
> [!NOTE]
>
> Available parameters vary by provider. See the [chat model integrations](lc:oss/python/integrations/chat/index) page for provider-specific configuration options.


### Provider profiles

A [`ProviderProfile`](lc:oss/python/deepagents/profiles#provider-profiles) packages initialization parameters that apply when you provide a `provider:model` string when creating the deep agent. It does not apply when you pass a preconfigured model with `init_chat_model`.
...
See [Profiles](lc:oss/python/deepagents/profiles) for the full field list, merge semantics, and plugin packaging.


> [!TIP]
>
> For shaping how the *agent* behaves once the model is built, use a [harness profile](lc:oss/python/deepagents/profiles#harness-profiles).


## Select a model at runtime

If your application lets users choose a model (for example using a dropdown in the UI), use [middleware](lc:oss/python/langchain/middleware/overview) to swap the model at runtime without rebuilding the agent.


Pass the user's model selection through [runtime context](lc:oss/python/langchain/models#dynamic-model-selection), then use a `wrap_model_call` middleware to override the model on each invocation using the `@wrap_model_call` decorator:
...
> [!TIP]
>
> For more dynamic model patterns (for example routing based on conversation complexity or cost optimization), see [Dynamic model](lc:oss/python/langchain/models#dynamic-model-selection) in the LangChain agents guide.


## Learn more

- [Models in LangChain](lc:oss/python/langchain/models): chat model features including tool calling, structured output, and multimodality
