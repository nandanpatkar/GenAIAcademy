...
> [!NOTE]
>
> ACP is designed for agent-editor integrations. If you want your agent to call tools hosted by external servers, see [Model Context Protocol (MCP)](lc:oss/python/langchain/mcp).
...
[
 {
  "label": "pip",
  "lang": "bash",
  "code": "pip install deepagents-acp"
 },
 {
  "label": "uv",
  "lang": "bash",
  "code": "uv add deepagents-acp"
 }
]
```
