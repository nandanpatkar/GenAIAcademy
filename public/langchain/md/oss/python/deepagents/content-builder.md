...
This guide demonstrates how to build a content writing agent from scratch using [Deep Agents](lc:oss/python/deepagents/overview).
...
- [Long-term memory](lc:oss/python/deepagents/memory) for TODO
- [Skills](lc:oss/python/deepagents/skills) for TODO
- [Subagents](lc:oss/python/deepagents/subagents) for TODO
- [Filesystem backends](lc:oss/python/deepagents/backends) for file read and write
- Custom [tools](lc:oss/python/langchain/tools) for search and image generation
...
[
 {
  "label": "pip wrap",
  "lang": "bash",
  "code": "pip install deepagents google-genai pillow pyyaml rich tavily-python langchain"
 },
 {
  "label": "uv wrap",
  "lang": "bash",
...
When you later create the agent and specify this file as part of the [memory](lc:oss/python/deepagents/memory) parameter, it gets loaded this into the system prompt so brand voice and research expectations apply to every run.
...
When creating the deep agent with `create_deep_agent`, pass memory paths, the skills directory, image tools, subagents from YAML, and a [FilesystemBackend](lc:oss/python/deepagents/backends) rooted at the example directory so paths like `./AGENTS.md` and `./skills/` resolve correctly.
...
[
 {
  "label": "Default wrap",
  "lang": "bash",
  "code": "python content_writer.py"
 },
 {
  "label": "With prompt wrap",
  "lang": "bash",
  "code": "python content_writer.py Write a blog post about prompt engineering"
 }
]
```


With `LANGSMITH_API_KEY` set, you can inspect runs in [LangSmith](lc:langsmith/observability).
...
- Read [Subagents](lc:oss/python/deepagents/subagents), [Skills](lc:oss/python/deepagents/skills), and [Customization](lc:oss/python/deepagents/customization) for deeper configuration
