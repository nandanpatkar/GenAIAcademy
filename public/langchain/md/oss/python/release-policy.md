This page explains the LangChain and LangGraph release policies. Click on the tabs below to view the release policies for each:
    ...
    **LangGraph 0.4**:
    ...
    - [Versioning](lc:oss/python/versioning) - Version numbering and support details
    - [Releases](https://docs.langchain.com/oss/releases) - Version-specific release notes and migration guides
