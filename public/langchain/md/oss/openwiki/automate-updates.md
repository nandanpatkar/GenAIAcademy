...
You can uncomment the corresponding line in the example workflow. To understand what is collected and how to opt out locally, see [Customize OpenWiki](lc:oss/openwiki/customize#telemetry).

## See also

- [Code mode](lc:oss/openwiki/code-mode)
- [Model providers](lc:oss/openwiki/providers)
- [CLI reference](lc:oss/openwiki/cli-reference)
