...
Create `.openwikiignore` at the repository root to exclude private, generated, or irrelevant paths from documentation runs. See [Code mode](lc:oss/openwiki/code-mode#ignore-paths) for syntax and behavior.
...
Code-mode repository artifacts such as the generated wiki, `openwiki/INSTRUCTIONS.md`, and `openwiki/.last-update.json` live in the project, not under `~/.openwiki/`. For more detail, see [Code mode](lc:oss/openwiki/code-mode) and [Personal mode](lc:oss/openwiki/personal-mode).
...
- [Code mode](lc:oss/openwiki/code-mode)
- [Personal mode](lc:oss/openwiki/personal-mode)
- [Automate updates](lc:oss/openwiki/automate-updates)
- [Model providers](lc:oss/openwiki/providers)
