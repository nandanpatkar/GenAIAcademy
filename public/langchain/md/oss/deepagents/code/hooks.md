...
[
 {
  "label": "title=\"~/.deepagents/hooks/block-rm.sh\"",
  "lang": "bash",
 ...
 {
  "label": "title=\"~/.deepagents/hooks.json\"",
  "lang": "json",
...
[
 {
  "label": "title=\"~/.deepagents/hooks/load-context.sh\"",
  "lang": "bash",
...
### Desktop notification when the turn ends on macOS (Stop)
...
- [Plugins and marketplaces](lc:oss/deepagents/code/plugins)
- [Data locations](lc:oss/deepagents/code/configuration#data-locations)
