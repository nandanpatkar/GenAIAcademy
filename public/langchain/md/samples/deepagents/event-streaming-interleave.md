...
>
> [Event streaming](lc:oss/python/deepagents/event-streaming)

```python event-streaming-interleave.py
"""Event streaming: synchronous interleave consumption."""
...
print("✓ event-streaming-interleave sample validated")
```
