...
```python evaluate-rag-reference.py
"""Consolidated RAG evaluation script for the LangSmith tutorial."""
...
if not os.environ.get("OPENAI_API_KEY") or not os.environ.get("LANGSMITH_API_KEY"):
    print(
        "[evaluate-rag-reference] Skipping (OPENAI_API_KEY and LANGSMITH_API_KEY required)."
    )
    sys.exit(0)
