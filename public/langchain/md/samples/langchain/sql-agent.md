...
>
> [SQL agent](lc:oss/python/langchain/sql-agent), [Custom SQL agent](lc:oss/python/langgraph/sql-agent)

```python sql-agent.py
"""Build a SQL agent with LangChain tools and optional human-in-the-loop review."""
