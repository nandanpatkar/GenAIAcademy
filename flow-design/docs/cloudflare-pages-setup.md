...
## Project 1: App (`app.flow-design.com`)

| Setting | Value |
|---|---|
| Repository | `GenAIAcademy/flow-design` |
...
## Project 2: Docs (`docs.flow-design.com`)
...
## Project 3: Landing (`flow-design.com` / `www.flow-design.com`)
...
1. **App**: Pages project settings → Custom domains → add `app.flow-design.com`
2. **Docs**: add `docs.flow-design.com`
3. **Landing**: add `flow-design.com` and `www.flow-design.com`
