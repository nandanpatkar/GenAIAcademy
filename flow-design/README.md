...
<img src="public/favicon.svg" width="72" alt="Flow Design" />
...
<p>
  <a href="https://github.com/GenAIAcademy/flow-design/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-f97316.svg?style=flat-square" alt="MIT License" /></a>
  <a href="https://github.com/GenAIAcademy/flow-design/stargazers"><img src="https://img.shields.io/github/stars/GenAIAcademy/flow-design?style=flat-square&color=facc15&label=Stars" alt="GitHub Stars" /></a>
  <a href="https://github.com/GenAIAcademy/flow-design/actions"><img src="https://img.shields.io/github/actions/workflow/status/GenAIAcademy/flow-design/quality.yml?style=flat-square&label=CI" alt="CI" /></a>
...
<p>
  <a href="https://app.flow-design.com"><b>→ Launch the App</b></a>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <a href="https://docs.flow-design.com">Documentation</a>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <a href="https://flow-design.com">Website</a>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <a href="https://github.com/GenAIAcademy/flow-design/issues">Issues</a>
  &nbsp;&nbsp;|&nbsp;&nbsp;
...
<a href="https://www.producthunt.com/products/flow-design" target="_blank">
  <img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-topic-badge.svg?post_id=1081019&theme=light&period=weekly&topic_id=44" alt="Flow Design on Product Hunt" width="200" height="43" />
</a>

<br/>
<br/>

<img src="readme-media/GIF-OFK-F.gif" alt="Flow Design in action" width="100%" />
...
<tr>
<td width="33%">
  <img src="readme-media/Sample -GIF-1.gif" alt="Flow Design demo 1" width="100%" />
</td>
<td width="33%">
  <img src="readme-media/Sample -GIF-2.gif" alt="Flow Design demo 2" width="100%" />
</td>
<td width="33%">
  <img src="readme-media/Sample -GIF-3.gif" alt="Flow Design demo 3" width="100%" />
</td>
</tr>
</table>
...
Every diagramming tool makes a compromise. Flow Design doesn't.
...
Paste any Mermaid flowchart, architecture, state diagram, class diagram, ER diagram, sequence diagram, mindmap, or journey — all 8 diagram families. Flow Design renders it on a visual canvas and automatically assigns the correct branded icon to every technology node.
...
Flow Design now treats the product as two clear surfaces:
...
Flowpilot sits directly in the editor. Describe a system, paste source code, upload a screenshot, or ask it to refine what's already on the canvas. Your API key is stored in your browser and sent directly to the provider — Flow Design's servers never see it.
...
Flow Design works best when you move between the right surfaces instead of forcing everything through one panel:
...
On modern browsers (Chrome / Edge / Safari 16.4+ / Firefox 130+) Flow Design encodes via **WebCodecs `VideoEncoder` + an in-browser MP4 muxer** — H.264 baseline, hardware-accelerated, **faster than real-time**, deterministic frame timing. No more dropped frames under load. MediaRecorder remains a fallback for older browsers, so the feature is purely additive.

---

## 🪄 MCP Server — drive Flow Design from Claude Desktop, Cursor, Windsurf

Point any MCP client at the [`@genai-roadmap/flow-design-mcp`](mcp-server/) package and your AI assistant gains local-first diagramming tools — no API key, no cloud round-trip. Your client already has an LLM, so Flow Design MCP supplies deterministic local validation, codebase analysis, templates, icon lookup, and viewer links.
...
```json
{
  "mcpServers": {
    "flow-design": {
      "command": "npx",
      "args": ["-y", "@genai-roadmap/flow-design-mcp"]
    }
  }
}
```

Then ask Claude: *"Read the Flow Design DSL cheatsheet, create a checkout flow with a promo-code branch and a Stripe webhook step, validate it, and create a viewer URL."* The DSL comes back in seconds and stays editable in Flow Design.
...
- ✅ **MCP server** — `@genai-roadmap/flow-design-mcp` for Claude Desktop, Cursor, Windsurf, any MCP client
...
```bash
git clone https://github.com/GenAIAcademy/flow-design.git
cd flow-design
npm install
npm run dev
```
...
Flow Design is a pure static SPA. There is no backend. Deploy the `dist/` folder anywhere that serves HTML.
...
```bash
docker build -t flow-design .
docker run --rm -p 3045:3045 flow-design
```
...
| Agent surface | `@genai-roadmap/flow-design-mcp` — Model Context Protocol stdio  |
...
**Good first issues** are tagged [`good first issue`](https://github.com/GenAIAcademy/flow-design/labels/good%20first%20issue). Before opening a PR, please read [CONTRIBUTING.md](CONTRIBUTING.md).
...
**Flow Design** is [MIT licensed](LICENSE), locally hosted, and built in the open.<br/>
...
|                                                                                            |                                                                                                      |                                        |                                                                      |
| :----------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: | :------------------------------------: | :------------------------------------------------------------------: |
|                      [**→ Launch App**](https://app.flow-design.com)                       |                               [**Docs**](https://docs.flow-design.com)                               | [**Website**](https://flow-design.com) | [**Changelog**](https://github.com/GenAIAcademy/flow-design/releases) |
| [Bug Report](https://github.com/GenAIAcademy/flow-design/issues/new?template=bug_report.md) | [Feature Request](https://github.com/GenAIAcademy/flow-design/issues/new?template=feature_request.md) | [Contributing Guide](CONTRIBUTING.md)  |                    [Security Policy](SECURITY.md)                    |
...
**[If Flow Design saves you time, the most impactful thing you can do is give it a star.](https://github.com/GenAIAcademy/flow-design/stargazers)**<br/>
**[It helps other developers find the project.](https://github.com/GenAIAcademy/flow-design/stargazers)**

<br/>

[![Star Flow Design on GitHub](https://img.shields.io/github/stars/GenAIAcademy/flow-design?style=for-the-badge&logo=github&color=facc15&label=Star%20on%20GitHub)](https://github.com/GenAIAcademy/flow-design/stargazers)

<br/>

[![Star History Chart](https://api.star-history.com/svg?repos=GenAIAcademy/flow-design&type=Date)](https://star-history.com/#GenAIAcademy/flow-design&Date)
