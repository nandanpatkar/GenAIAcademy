...
const IMPORT_REPORT_STORAGE_KEY = 'flow-design-import-report-latest';
...
export function getImportRecoveryGuidance(report: ImportFidelityReport): string {
    ...
    return 'If this file came from another tool, try exporting a plain JSON/Flow Design file again or remove unsupported metadata before retrying.';
}
