...
import { CustomIconsSettings } from '../SettingsModal/CustomIconsSettings';

type HomeSettingsTab = 'general' | 'canvas' | 'shortcuts' | 'ai' | 'custom-icons';
