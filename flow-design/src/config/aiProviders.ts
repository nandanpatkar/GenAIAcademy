...
export const PROVIDER_BASE_URLS: Record<Exclude<AIProvider, 'gemini' | 'claude' | 'azure-openai' | 'custom'>, string> = {
...
export const PROVIDERS: ProviderMeta[] = [
    ...
    },
    {
        ...
        icon: '◈',
        color: '#0078d4',
        logoPath: './logos/azure-openai.svg',
        keyPlaceholder: 'Azure OpenAI API key',
        keyLink: 'https://ai.azure.com',
        consoleName: 'Microsoft Foundry',
        defaultModel: getDefaultModel('azure-openai'),
    },
    {
        id: 'claude',
        name: 'Claude',
...
export const DEFAULT_BASE_URLS: Record<Exclude<AIProvider, 'gemini' | 'claude' | 'azure-openai'>, string> = {
