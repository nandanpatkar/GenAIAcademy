...
description: Using Flow Design on tablets and phones — capabilities, limitations, and best practices.
---

Flow Design is designed primarily for desktop browsers, but it provides a functional experience on tablets and phones.

## Supported Devices

Flow Design works on:
...
1. **Review and present**: Flow Design is great for viewing diagrams on mobile during meetings or code reviews
