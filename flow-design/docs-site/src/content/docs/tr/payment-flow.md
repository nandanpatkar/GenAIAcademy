...
description: Abonelik, checkout, retry ve istisna yolları içeren ödeme sistemlerini Flow Design ile modelleyin.
---

Ödeme sistemleri, mutlu yolun ötesinde retry, hata işleme, manuel inceleme ve bildirim dalları içerdiği için Flow Design için çok uygun bir kullanım alanıdır.
