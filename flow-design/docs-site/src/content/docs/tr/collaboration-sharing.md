...
description: Oda bağlantıları paylaşın, local-only fallback davranışını anlayın ve Flow Design ortak çalışma akışlarını doğru kullanın.
---

Flow Design, varsayılan local-first davranışı korurken paylaşım bağlantıları ve ortak çalışma odası akışlarını destekler.
