...
description: Düzenleme, dokümantasyon, ortak çalışma, gömme veya tasarım aracı aktarımı için doğru Flow Design dışa aktarma formatını seçin.
---

Flow Design hem görsel hem de düzenlenebilir teslim formatlarını destekler. En doğru seçim bir sonraki adıma göre belirlenir.
