...
Infrastructure Sync, gerçek altyapı dosyalarını deterministik şekilde Flow Design diyagramlarına dönüştürür.
...
Oluşturulan sonuç yine normal bir Flow Design diyagramıdır. Uyguladıktan sonra düzen, açıklama, dışa aktarma ve karşılaştırma akışlarına devam edebilirsiniz.
