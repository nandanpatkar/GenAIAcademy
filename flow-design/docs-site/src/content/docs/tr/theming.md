...
draft: false
title: Theming
description: Flow Design içinde tasarım sistemleri kullanarak her diyagramı tek tek stillendirmeden tutarlı bir görsel dil kurun.
---

Flow Design, tema yönetimini tek tek diyagram stilleri yerine tekrar kullanılabilir tasarım sistemleri üzerinden ele alır.

## Flow Design içinde theming ne anlama gelir?
