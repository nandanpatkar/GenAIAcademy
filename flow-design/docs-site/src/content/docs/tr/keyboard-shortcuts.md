...
description: Flow Design’te düzenleme, gezinme ve diyagram üretimi için mevcut klavye kısayolları.
---
...
- Doğrudan kısayolu olmayan işlemler için [Command Center](/tr/command-center/) kullanabilirsiniz.
