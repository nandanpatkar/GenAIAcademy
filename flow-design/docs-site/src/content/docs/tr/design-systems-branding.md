...
description: Tutarlı diyagramlar için Flow Design tasarım sistemlerini yönetin ve tema tanımlarını içe veya dışa aktarın.
---

Flow Design, diyagramların tek tek elle stillenmesi yerine tekrar kullanılabilir bir görsel sistemle çalışmasını sağlayan tasarım sistemi desteğine sahiptir.
