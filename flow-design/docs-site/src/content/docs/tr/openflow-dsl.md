...
draft: false
title: OpenFlow DSL
description: Flow Design diyagramları için editör-doğal metin temsili olan OpenFlow DSL’i kullanın.
---

OpenFlow DSL, Flow Design Studio’da kullanılan yerel metinsel temsildir. Kod tabanlı bir çalışma istiyor ama editör modeline yakın kalmak istiyorsanız en iyi seçenektir.
...
- Mermaid’e göre Flow Design’e daha yakın bir temsil gerektiğinde
...
- Flow Design ana düzenleme ortamıysa
