...
draft: false
title: Theming
description: Use design systems in Flow Design to keep diagram styling consistent without manually restyling every canvas.
---

Flow Design handles theming through reusable design systems rather than ad hoc per-diagram styling.

## What theming means in Flow Design
