...
description: Historical release note for the Flow Design V1 beta milestone and the product direction it introduced.
---
...
The V1 beta marked the point where Flow Design stopped being treated as a basic flowchart tool and became a broader local-first diagramming workspace.
