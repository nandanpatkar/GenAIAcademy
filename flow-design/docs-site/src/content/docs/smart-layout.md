...
draft: false
title: Smart Layout
description: Use ELK-based layout to turn rough graphs into cleaner, more readable diagrams in Flow Design.
---

Flow Design uses ELK-based layout strategies to turn rough graphs into readable diagrams quickly.
