...
draft: false
title: Quick Start
description: Create your first Flow Design diagram from builder templates, imports, AI, code, or the canvas.
---
...
Flow Design works best when you start from the most truthful source available, then refine visually.
