...
description: Pick the right Flow Design export format for editing, docs, collaboration, embeds, or design-tool handoff.
---

Flow Design supports both visual exports and editable handoff formats. The right format depends on what happens next.
...
- Use OpenFlow DSL when Flow Design remains the editing home.
