...
description: Share room links, understand local-only fallback behavior, and use Flow Design collaboration features safely.
---

Flow Design supports share links and collaboration-oriented room flows while keeping local-first behavior as the default.
