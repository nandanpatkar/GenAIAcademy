...
draft: false
title: Exporting
description: Export diagrams from Flow Design as images, cinematic media, JSON, code formats, design-tool handoff, or share/embed links.
---
...
This is the most faithful archival format for re-import into Flow Design. Use it for:
