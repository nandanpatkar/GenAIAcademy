...
draft: false
title: Roadmap
description: Current product direction for Flow Design, separated clearly from already shipped behavior.
---
...
- **MCP Server**: Drive Flow Design from Claude Desktop, Cursor, Windsurf, and other MCP clients
