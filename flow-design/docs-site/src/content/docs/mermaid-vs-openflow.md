...
description: Decide whether Mermaid or OpenFlow DSL is the better text representation for your Flow Design workflow.
---

Mermaid and OpenFlow DSL solve adjacent but different problems in Flow Design.
...
- the diagram is primarily maintained inside Flow Design
- you want a format closer to the native graph model
- you want fewer compatibility constraints during editing
- you want a better target for Flow Design-specific AI and Studio workflows
